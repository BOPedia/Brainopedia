...
export function ArticleContent({ articleId, setCurrentArticle, tabId }: ArticleContentProps) {
  const articles: Record<string, React.ReactNode> = {
    ...
    'adhd-causes': <ADHDCauses setCurrentArticle={setCurrentArticle} initialTab={tabId} />,
    'adhd-diagnosis': <ADHDDiagnosis setCurrentArticle={setCurrentArticle} initialTab={tabId} />,
    'adhd-support': <ADHDSupport setCurrentArticle={setCurrentArticle} initialTab={tabId} />,
    'adhd-living': <ADHDLiving setCurrentArticle={setCurrentArticle} initialTab={tabId} />,
    ...
    'dyslexia-overview': <DyslexiaOverview setCurrentArticle={setCurrentArticle} initialTab={tabId} />,
    'dyslexia-symptoms': <DyslexiaSymptoms setCurrentArticle={setCurrentArticle} initialTab={tabId} />,
    'dyslexia-causes': <DyslexiaCauses setCurrentArticle={setCurrentArticle} />,
    'dyslexia-diagnosis': <DyslexiaDiagnosis setCurrentArticle={setCurrentArticle} initialTab={tabId} />,
    'dyslexia-support': <DyslexiaSupport setCurrentArticle={setCurrentArticle} />,
    'dyslexia-living': <DyslexiaLiving setCurrentArticle={setCurrentArticle} initialTab={tabId} />,
    dyscalculia: <ArticleDyscalculia setCurrentArticle={setCurrentArticle} />,
    'dyscalculia-overview': <DyscalculiaOverview setCurrentArticle={setCurrentArticle} initialTab={tabId} />,
