      ...
      <div className="space-y-12">
        ...
        <section className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-[#2abcd4]/20 to-[#2abcd4]/5 p-6 rounded-xl border-2 border-[#2abcd4] shadow-sm overflow-hidden">
            <h3 className="text-[#0c264d] text-xl font-bold mb-4 text-center sm:text-left">Core Neurodevelopmental</h3>
            <img src="/images/home-apple-core-neurodev.png" alt="Neural apple" className="float-none sm:float-left block mx-auto sm:mx-0 mb-4 sm:mb-2 mr-0 sm:mr-5 w-32 h-auto rounded-lg shadow-md" />
            <p className="mb-4 text-base leading-relaxed text-center sm:text-left">Fundamental neurodevelopmental conditions affecting attention, social communication, and sensory processing from early childhood.</p>
            <div className="flex flex-wrap gap-2 mt-4 justify-center sm:justify-start clear-both">
          ...
          <div className="bg-gradient-to-br from-[#ffd166]/30 to-[#ffd166]/5 p-6 rounded-xl border-2 border-[#ffd166] shadow-sm overflow-hidden">
            <h3 className="text-[#0c264d] text-xl font-bold mb-4 text-center sm:text-left">Learning Differences & Profiles</h3>
            <img src="/images/home-learning-diff.png" alt="Gears" className="float-none sm:float-left block mx-auto sm:mx-0 mb-4 sm:mb-2 mr-0 sm:mr-5 w-32 h-auto rounded-lg shadow-md" />
            <p className="mb-4 text-base leading-relaxed text-center sm:text-left">Profiles affecting how individuals process, retain, and express information across reading, writing, and math.</p>
            <div className="flex flex-wrap gap-2 mt-4 justify-center sm:justify-start clear-both">
          ...
          <div className="bg-gradient-to-br from-[#ec4899]/20 to-[#ec4899]/5 p-6 rounded-xl border-2 border-[#ec4899] shadow-sm overflow-hidden">
            <h3 className="text-[#0c264d] text-xl font-bold mb-4 text-center sm:text-left">Processing & Sensory</h3>
            <img src="/images/home-math-sensory-brain.png" alt="Sensory" className="float-none sm:float-left block mx-auto sm:mx-0 mb-4 sm:mb-2 mr-0 sm:mr-5 w-32 h-auto rounded-lg shadow-md" />
            <p className="mb-4 text-base leading-relaxed text-center sm:text-left">Atypical ways of interpreting sensory information like auditory, visual, and tactile inputs.</p>
            <div className="flex flex-wrap gap-2 mt-4 justify-center sm:justify-start clear-both">
          ...
          <div className="bg-gradient-to-br from-[#ffd700]/30 to-[#ffd700]/5 p-6 rounded-xl border-2 border-[#ffd700] shadow-sm overflow-hidden">
            <h3 className="text-[#0c264d] text-xl font-bold mb-4 text-center sm:text-left">Movement & Motor</h3>
            <img src="/images/home-movement-motor.png" alt="Motor" className="float-none sm:float-left block mx-auto sm:mx-0 mb-4 sm:mb-2 mr-0 sm:mr-5 w-32 h-auto rounded-lg shadow-md" />
            <p className="mb-4 text-base leading-relaxed text-center sm:text-left">Conditions affecting the brain's ability to plan, coordinate, and execute physical movements.</p>
            <div className="flex flex-wrap gap-2 mt-4 justify-center sm:justify-start clear-both">
          ...
          <div className="bg-gradient-to-br from-[#0a9dc4]/20 to-[#0a9dc4]/5 p-6 rounded-xl border-2 border-[#0a9dc4] shadow-sm overflow-hidden">
            <h3 className="text-[#0c264d] text-xl font-bold mb-4 text-center sm:text-left">Mental Health Crossovers</h3>
            <img src="/images/home-mental-health-fire-brain-bright.png" alt="Brain" className="float-none sm:float-left block mx-auto sm:mx-0 mb-4 sm:mb-2 mr-0 sm:mr-5 w-32 h-auto rounded-lg shadow-md" />
            <p className="mb-4 text-base leading-relaxed text-center sm:text-left">Distinctive neurological patterns at the intersection of neurodivergence and mental health.</p>
            <div className="flex flex-wrap gap-2 mt-4 justify-center sm:justify-start clear-both">
          ...
          <div className="bg-gradient-to-br from-[#8b5cf6]/20 to-[#8b5cf6]/5 p-6 rounded-xl border-2 border-[#8b5cf6] shadow-sm overflow-hidden">
            <h3 className="text-[#0c264d] text-xl font-bold mb-4 text-center sm:text-left">Genetic or Environmental</h3>
            <img src="/images/home-genetics-or-enviro.png" alt="DNA" className="float-none sm:float-left block mx-auto sm:mx-0 mb-4 sm:mb-2 mr-0 sm:mr-5 w-32 h-auto rounded-lg shadow-md" />
            <p className="mb-4 text-base leading-relaxed text-center sm:text-left">Conditions arising from genetic variations or environmental factors during early development.</p>
            <div className="flex flex-wrap gap-2 mt-4 justify-center sm:justify-start clear-both">
          ...
          <div className="bg-gradient-to-br from-[#ffcc00]/25 to-[#ffcc00]/5 p-6 rounded-xl border-2 border-[#ffcc00] shadow-sm overflow-hidden">
            <h3 className="text-[#0c264d] text-xl font-bold mb-4 text-center sm:text-left">Acquired Neurodivergence</h3>
            <img src="/images/home-acquired-brain.png" alt="Injury" className="float-none sm:float-left block mx-auto sm:mx-0 mb-4 sm:mb-2 mr-0 sm:mr-5 w-32 h-auto rounded-lg shadow-md" />
            <p className="mb-4 text-base leading-relaxed text-center sm:text-left">Differences developing after birth due to injury, illness, or environmental factors.</p>
            <div className="flex flex-wrap gap-2 mt-4 justify-center sm:justify-start clear-both">
