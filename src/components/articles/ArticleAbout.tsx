      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gradient-to-br from-[#2abcd4]/20 to-[#2abcd4]/5 p-6 rounded-xl border-2 border-[#2abcd4] shadow-sm hover:shadow-md transition-shadow">
              ...
              <div>
                <img 
                  ...
                  className="float-left mr-4 mb-3 w-28 sm:w-32 h-auto rounded-lg shadow-md"
                />
            ...
            {/* Movement & Motor */}
            <div className="bg-gradient-to-br from-[#ffd700]/30 to-[#ffd700]/5 p-4 rounded-xl border-2 border-[#ffd700] shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-[#0c264d] text-base font-bold mb-3">
                Movement & Motor
              </h3>
