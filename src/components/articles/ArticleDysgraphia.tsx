      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="space-y-6">
          <p>
            ...
            despite adequate language and cognitive abilities.<sup>12</sup>
          </p>
      ...
      <div className="space-y-8 mt-20 clear-both">
        <section id="overview" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <p className="mb-4">
            ...
            basis.<sup>13</sup> It is not related to intelligence—individuals with dysgraphia can have average or 
            above-average cognitive abilities and may excel in verbal communication, creative thinking, 
            or other academic areas.<sup>14</sup> The condition involves difficulties with the mechanical aspects of writing, 
        ...
        <section id="characteristics" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <p className="mb-4">
            ...
            lowercase letters inappropriately, and inconsistent spacing between letters and words.<sup>16</sup> Beyond handwriting 
