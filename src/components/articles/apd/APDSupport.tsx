      ...
      <div className="space-y-8">
        <div>
          <p className="mb-4">
            ...
            Effective support is individualized based on the specific deficits, age, and functional impacts.<sup>12</sup>
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mb-4">
            Changing the listening environment to optimize signal-to-noise ratio and reduce auditory demands.<sup>13</sup> 
            This is often the most immediately effective intervention component.<sup>14</sup>
          </p>
          ...
          <p className="mb-4">
            ...
            individuals function more effectively despite persistent difficulties.<sup>16</sup>
          </p>
