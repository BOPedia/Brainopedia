      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="mb-4">
            ...
            through the auditory cortex.<sup>13</sup> These structures process, analyze, and integrate auditory 
            information received from the ears.<sup>14</sup> Differences in how these pathways function underlie 
          ...
          <p className="mb-4">
            ...
            complex, and inferior colliculus.<sup>16</sup> These structures process temporal information, sound 
