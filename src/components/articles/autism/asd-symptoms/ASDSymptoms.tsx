...
{/* --- PAGE HEADER SECTION --- */}
      ...
      <div className="pb-2 border-b-2 border-[#0c264d] mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        ...
        <button 
          ...
          className="bg-[#ffd166] text-[#0c264d] px-5 py-2.5 rounded-lg font-semibold text-sm shadow-sm hover:bg-[#0c264d] hover:text-white transition-all flex items-center gap-2 font-spartan"
        >
