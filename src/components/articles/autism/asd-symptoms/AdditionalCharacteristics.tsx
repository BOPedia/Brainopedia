      ...
      <div className="space-y-6">
       ...
       />
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="border-l-2 border-[#2abcd4] pl-3">
                ...
                <div className="text-sm">Difficulty identifying and describing one's own emotions (common in ~50% of autistic people)<sup>12</sup></div>
              </div>
            </div>
        ...
        <div className="bg-white p-5 rounded-md border-l-4 border-[#0c264d] shadow-sm mb-6">
          ...
          <p className="mb-4 text-sm">
            Challenges in motor coordination, motor planning, and unusual gait or movements.<sup>13</sup>
          </p>
