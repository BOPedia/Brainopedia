  ...
  return (
    <div className="bg-[#f0f9ff] p-6 rounded-lg">
      ...
      <p className="mb-6">
        ...
        current functioning.<sup className="text-green-700 font-bold ml-0.5">[1]</sup> Early diagnosis enables earlier access to support and services, which 
          ...
          <div className="flex-1 relative">
            <div className="bg-[#e0f2fe] border-2 border-[#0A9DC4] rounded-lg p-4 h-full">
              ...
              <div className="text-sm space-y-1">
                <p>• General screening at 9, 18, 24 or 30 months<sup className="text-green-700 font-bold ml-0.5">[2]</sup></p>
      ...
      <div className="bg-white p-5 rounded-md border-l-4 border-[#0c264d] shadow-sm mb-6">
        ...
        <p className="text-sm mb-4">
          These tools are considered the "gold standard" for autism diagnosis:<sup className="text-green-700 font-bold ml-0.5">[3]</sup>
        </p>
          ...
          <div className="border-2 border-[#0A9DC4] rounded-lg overflow-hidden">
            ...
            <div className="p-4 text-sm space-y-3">
              ...
              <div className="flex items-start gap-2">
                ...
                <div><strong>Note:</strong> Most widely used observational assessment<sup className="text-green-700 font-bold ml-0.5">[3]</sup></div>
              </div>
            </div>
          </div>
