...
{/* --- CENTERED GRAPHIC SECTION 1 --- */} 
          ...
          <table className="medication-table w-full border-2 border-[#2abcd4] rounded-lg text-sm">
            ...
            <tbody>
              ...
              <tr className="bg-white border-b border-[#2abcd4]">
                ...
                <td className="p-3">Ages 5-16; monitor weight gain, metabolic effects<sup className="text-green-600 font-bold ml-0.5">2</sup></td>
              </tr>
              <tr className="bg-gray-200 border-b border-[#2abcd4]">
                ...
                <td className="p-3">Ages 6-17; less weight gain than risperidone<sup className="text-green-600 font-bold ml-0.5">2</sup></td>
              </tr>
              ...
              <tr className="bg-white border-b border-[#2abcd4]">
                ...
                <td className="p-3">Effective for co-occurring ADHD; monitor for increased irritability<sup className="text-green-600 font-bold ml-0.5">3</sup></td>
              </tr>
              <tr className="bg-gray-200 border-b border-[#2abcd4]">
                ...
                <td className="p-3">For ADHD symptoms; may reduce appetite<sup className="text-green-600 font-bold ml-0.5">3</sup></td>
              </tr>
              <tr className="bg-white border-b border-[#2abcd4]">
                ...
                <td className="p-3">Alternative to stimulants; takes weeks to work<sup className="text-green-600 font-bold ml-0.5">3</sup></td>
              </tr>
              <tr className="bg-gray-200 border-b border-[#2abcd4]">
                ...
                <td className="p-3">May help with emotional regulation<sup className="text-green-600 font-bold ml-0.5">3</sup></td>
              </tr>
              ...
              <tr className="bg-white border-b border-[#2abcd4]">
                ...
                <td className="p-3">Monitor for activation/behavioral side effects<sup className="text-green-600 font-bold ml-0.5">4</sup></td>
              </tr>
              <tr className="bg-gray-200 border-b border-[#2abcd4]">
                ...
                <td className="p-3">Mixed evidence; autistic individuals may be more sensitive to side effects<sup className="text-green-600 font-bold ml-0.5">4</sup></td>
              </tr>
              <tr className="bg-white border-b border-[#2abcd4]">
                ...
                <td className="p-3">Generally well-tolerated<sup className="text-green-600 font-bold ml-0.5">4</sup></td>
              </tr>
              ...
              <tr className="bg-white border-b border-[#2abcd4]">
                ...
                <td className="p-3">First-line for sleep; well-studied in autism, generally safe<sup className="text-green-600 font-bold ml-0.5">5</sup></td>
              </tr>
              <tr className="bg-gray-200 border-b border-[#2abcd4]">
                ...
                <td className="p-3">Sedating; monitor blood pressure<sup className="text-green-600 font-bold ml-0.5">5</sup></td>
              </tr>
              ...
              <tr className="bg-white border-b border-[#2abcd4]">
                ...
                <td className="p-3">For co-occurring epilepsy; monitor liver function<sup className="text-green-600 font-bold ml-0.5">6</sup></td>
              </tr>
              <tr className="bg-gray-200 border-b border-[#2abcd4]">
                ...
                <td className="p-3">For epilepsy; generally well-tolerated<sup className="text-green-600 font-bold ml-0.5">6</sup></td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <p className="mb-4 bg-yellow-50 border-l-4 border-yellow-400 p-4">
          ...
          monitor carefully.<sup className="text-green-600 font-bold ml-0.5">7</sup> Always work with a qualified healthcare provider who understands autism when considering medication.
        </p>
        ...
        <p className="mb-4">
          Gastrointestinal problems affect 46-84% of autistic individuals, significantly higher than the general population.<sup className="text-green-600 font-bold ml-0.5">8</sup> Common issues include chronic constipation, diarrhea, abdominal pain, gastroesophageal reflux disease (GERD), and feeding difficulties.
        </p>
        ...
        <div className="bg-blue-50 border-l-4 border-[#2abcd4] p-4 mb-6">
          ...
          <ul className="list-disc ml-6 text-sm space-y-1">
            <li><strong>Rule out underlying conditions:</strong> Celiac disease, food allergies, inflammatory bowel disease should be evaluated<sup className="text-green-600 font-bold ml-0.5">9</sup></li>
            <li><strong>Dietary modifications:</strong> Some children benefit from addressing food selectivity, increasing fiber, or identifying trigger foods<sup className="text-green-600 font-bold ml-0.5">9</sup></li>
            <li><strong>Hydration:</strong> Ensure adequate fluid intake, especially with fiber supplements or laxatives<sup className="text-green-600 font-bold ml-0.5">9</sup></li>
            <li><strong>Communication challenges:</strong> Nonverbal children may show behavioral changes as only sign of GI distress<sup className="text-green-600 font-bold ml-0.5">9</sup></li>
            <li><strong>Medication side effects:</strong> Some psychotropic medications can worsen constipation<sup className="text-green-600 font-bold ml-0.5">9</sup></li>
            <li><strong>Toileting issues:</strong> Address sensory aversions, fear of toilet, or lack of interoceptive awareness<sup className="text-green-600 font-bold ml-0.5">9</sup></li>
          </ul>
        </div>

        <h4 className="text-[#0c264d] font-bold mb-3">Other Co-occurring Medical Conditions</h4>
        <ul className="list-disc ml-6 mb-4">
          <li className="mb-2"><strong>Sleep disorders:</strong> Insomnia, irregular sleep-wake cycles; sleep hygiene, melatonin<sup className="text-green-600 font-bold ml-0.5">10</sup></li>
          <li className="mb-2"><strong>Seizure disorders:</strong> Higher prevalence in autism; regular neurology follow-up<sup className="text-green-600 font-bold ml-0.5">11</sup></li>
          <li className="mb-2"><strong>Immune dysregulation:</strong> Some evidence of immune differences; manage allergies, autoimmune conditions<sup className="text-green-600 font-bold ml-0.5">12</sup></li>
        </ul>
        ...
        <ul className="list-disc ml-6 mb-4">
          ...
          <li className="mb-2"><strong>Preventive care:</strong> Don't neglect routine care (dental, vision, well visits) despite challenges<sup className="text-green-600 font-bold ml-0.5">13</sup></li>
          <li className="mb-2"><strong>Transition to adult care:</strong> Plan transition from pediatric to adult providers<sup className="text-green-600 font-bold ml-0.5">14</sup></li>
        </ul>
      </div>
