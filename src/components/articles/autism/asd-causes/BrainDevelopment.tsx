   ...
   <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white p-5 rounded-lg shadow-sm border-l-4 border-[#ffd166]">
          ...
          <ul className="list-disc ml-5 space-y-2 text-sm text-gray-700">
            <li><strong>Neural connectivity patterns:</strong> Reduced long-range connectivity but increased local connectivity in some regions.<sup>12</sup></li>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border-t-4 border-[#2abcd4] mb-10">
        ...
        <div className="grid md:grid-cols-3 gap-4 text-center">
          ...
          <div className="p-3">
            ...
            <p className="text-sm text-gray-700">Imbalance between excitatory and inhibitory neurotransmission.<sup>13</sup></p>
          </div>
        </div>
