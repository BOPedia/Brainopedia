    ...
    <div className="bg-[#e0f7fa] p-6 rounded-lg text-[#0c264d]">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white p-5 rounded-lg shadow-sm border-l-4 border-[#2abcd4]">
          ...
          <ul className="list-disc ml-5 space-y-2 text-sm text-[#0c264d] opacity-90">
            <li><strong>Advanced parental age:</strong> Both maternal and paternal age over 35.<sup className="text-[#0c264d] font-extrabold ml-0.5">12</sup></li>
            <li><strong>Maternal infections:</strong> Severe infections, particularly in the second trimester.<sup className="text-[#0c264d] font-extrabold ml-0.5">13</sup></li>
            <li><strong>Maternal immune activation:</strong> Immune responses affecting fetal brain development.<sup className="text-[#0c264d] font-extrabold ml-0.5">13</sup></li>
            <li><strong>Certain medications:</strong> Valproic acid exposure during pregnancy.<sup className="text-[#0c264d] font-extrabold ml-0.5">14</sup></li>
            <li><strong>Prenatal nutrition:</strong> Deficiencies in nutrients like folic acid.<sup className="text-[#0c264d] font-extrabold ml-0.5">13</sup></li>
            ...
            <li><strong>Air pollution:</strong> Exposure during pregnancy and early life.<sup className="text-[#0c264d] font-extrabold ml-0.5">13</sup></li>
          </ul>
        </div>
        ...
        <div className="bg-white p-5 rounded-lg shadow-sm border-l-4 border-[#ffd166]">
          ...
          <ul className="list-disc ml-5 space-y-2 text-sm text-[#0c264d] opacity-90">
            ...
            <li><strong>Birth complications:</strong> Significant oxygen deprivation (hypoxia).<sup className="text-[#0c264d] font-extrabold ml-0.5">13</sup></li>
      ...
      <div className="bg-[#2abcd4] bg-opacity-20 p-5 rounded-lg border-2 border-dashed border-[#0c264d] border-opacity-30 mb-10">
        ...
        <p className="text-sm leading-relaxed text-[#0c264d]">
          Environmental factors likely don't act alone but interact with genetic susceptibility. Genetic vulnerability may determine which environmental factors affect a child, or environmental factors may "trigger" a genetic risk in susceptible individuals.<sup className="text-[#0c264d] font-extrabold ml-0.5">12</sup>
        </p>
      </div>
