      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div className="space-y-6">
          <p>
            ...
            creating a unique sensory neurotype that shapes how they interact with their surroundings.<sup>12</sup>
          </p>
      ...
      <div className="space-y-8 mt-20 clear-both">
        <section id="overview" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <p className="mb-4">
            ...
            exist as a distinct diagnosis.<sup>13</sup> The condition affects how the nervous system detects, modulates, 
            discriminates, and integrates sensory input—essentially, how the brain's "filters" work when 
            processing the constant stream of sensory information.<sup>14</sup>
          </p>
          ...
          <p className="mb-4">
            ...
            fundamentally different lived experience of sensation.<sup>16</sup> SPD can affect any of the eight sensory 
