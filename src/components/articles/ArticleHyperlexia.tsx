    ...
    <article className="max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="space-y-6">
          <p>
            ...
            difficulties with verbal language comprehension and social communication.<sup>12</sup>
          </p>
      ...
      <div className="space-y-8 mt-20 clear-both">
        <section id="overview" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <p className="mb-4">
            Hyperlexia is relatively rare and is estimated to affect fewer than 1% of the population.<sup>13</sup> 
            ...
            and written symbols.<sup>14</sup>
          </p>
          ...
          <p className="mb-4">
            ...
            abstract concepts and inferential reasoning.<sup>16</sup>
          </p>
        </section>
