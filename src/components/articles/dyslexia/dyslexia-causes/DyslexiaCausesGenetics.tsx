      ...
      <Tabs defaultValue="genetics" className="w-full">
        ...
        <TabsContent value="genetics" className="animate-fadeIn">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="bg-[#ffd166]/20 border-t-4 border-[#0c264d] rounded-xl p-5 shadow-sm">
            ...
            <div className="bg-[#ffd166]/20 border-t-4 border-[#ffd166] rounded-xl p-5 shadow-sm">
            ...
            <div className="bg-[#ffd166]/20 border-t-4 border-[#0A9DC4] rounded-xl p-5 shadow-sm">
            ...
            <div className="bg-[#ffd166]/20 border-t-4 border-[#2abcd4] rounded-xl p-5 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
            <div className="bg-[#ffd166]/20 border border-[#ffd166]/30 rounded-lg p-5 shadow-sm flex items-start gap-4">
