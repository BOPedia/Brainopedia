        ...
        <TabsContent value="risk" className="animate-fadeIn">
          ...
          <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6 mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex items-start gap-2">
                <span className="text-red-500 font-bold text-lg leading-none mt-0.5">✗</span>
                <p className="text-sm text-slate-800"><strong>Poor parenting/teaching:</strong> While instruction quality matters, it doesn't cause dyslexia.<sup className="text-green-600 font-bold ml-0.5">13</sup></p>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-red-500 font-bold text-lg leading-none mt-0.5">✗</span>
          ...
          <p className="mb-4 text-slate-700">The current scientific consensus views dyslexia as a multifactorial condition:</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-slate-700 mb-2">Understanding dyslexia's causes informs treatment:<sup className="text-green-600 font-bold ml-0.5">14</sup></p>
              <ul className="list-disc ml-5 space-y-1 text-sm text-slate-700">
                ...
                <li>Understanding biological basis reduces stigma and blame.<sup className="text-green-600 font-bold ml-0.5">15</sup></li>
              </ul>
            </div>

            <div>
              <h3 className="text-xl font-bold mb-3 text-[#0c264d] border-b border-gray-100 pb-2">Ongoing Research</h3>
              <p className="text-sm text-slate-700 mb-2">Dyslexia research continues to evolve:<sup className="text-green-600 font-bold ml-0.5">16</sup></p>
              <ul className="list-disc ml-5 space-y-1 text-sm text-slate-700">
                ...
                <li>Understanding heterogeneity within dyslexia population.<sup className="text-green-600 font-bold ml-0.5">17</sup></li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-white bg-opacity-50 p-6 rounded-lg shadow-inner">
            ...
            <div className="mb-6">
              ...
              <div className="text-xs space-y-3 text-slate-600 leading-relaxed" style={{ textIndent: 0 }}>
                <p>1. Snowling, M. J., & Melby-Lervåg, M. (2016). "Oral language deficits in familial dyslexia: A meta-analysis and review." <em>Psychological Bulletin</em>, 142(5), 498-545.</p>
                <p>2. Torgesen, J. K. (2004). "Lessons learned from research on interventions for students who have difficulty learning to read." In <em>The voice of evidence in reading research</em> (pp. 355-382). Paul H. Brookes.</p>
                <p>3. Snowling, M. J., & Hulme, C. (2011). "Evidence‐based interventions for reading and language difficulties: Creating a virtuous circle." <em>British Journal of Educational Psychology</em>, 81(1), 1-23.</p>
                <p>4. Noble, K. G., Wolmetz, M. E., Ochs, L. G., Farah, M. J., & McCandliss, B. D. (2006). "Brain–behavior relationships in reading acquisition are modulated by socioeconomic factors." <em>Developmental Science</em>, 9(6), 642-654.</p>
                <p>5. Ziegler, J. C., & Goswami, U. (2005). "Reading acquisition, developmental dyslexia, and skilled reading across languages: A psycholinguistic grain size theory." <em>Psychological Bulletin</em>, 131(1), 3-29.</p>
                <p>6. Share, D. L. (2008). "On the Anglocentricities of current reading research and practice: The perils of overreliance on an outlier orthography." <em>Psychological Bulletin</em>, 134(4), 584-615.</p>
                <p>7. Paulesu, E., Démonet, J. F., Fazio, F., et al. (2001). "Dyslexia: Cultural diversity and biological unity." <em>Science</em>, 291(5511), 2165-2167.</p>
                <p>8. Espy, K. A., Molfese, D. L., Molfese, V. J., & Modglin, A. (2004). "Development of auditory event-related potentials in young children and relations to word-level reading abilities at age 8 years." <em>Annals of Dyslexia</em>, 54(1), 9-38.</p>
                <p>9. Litt, J., Taylor, H. G., Klein, N., & Hack, M. (2005). "Learning disabilities in children with very low birthweight: Prevalence, neuropsychological correlates, and educational interventions." <em>Journal of Learning Disabilities</em>, 38(2), 130-141.</p>
                <p>10. Vellutino, F. R., Fletcher, J. M., Snowling, M. J., & Scanlon, D. M. (2004). "Specific reading disability (dyslexia): What have we learned in the past four decades?" <em>Journal of Child Psychology and Psychiatry</em>, 45(1), 2-40.</p>
                <p>11. Fischer, F. W., Liberman, I. Y., & Shankweiler, D. (1978). "Reading reversals and developmental dyslexia: A further study." <em>Cortex</em>, 14(4), 496-510.</p>
                <p>12. Ferrer, E., Shaywitz, B. A., Holahan, J. M., Marchione, K., & Shaywitz, S. E. (2010). "Uncoupling of reading and IQ over time: Empirical evidence for a definition of dyslexia." <em>Psychological Science</em>, 21(1), 93-101.</p>
                <p>13. Snowling, M. J., & Hulme, C. (2012). "Annual research review: The nature and classification of reading disorders–a commentary on proposals for DSM‐5." <em>Journal of Child Psychology and Psychiatry</em>, 53(5), 593-607.</p>
                <p>14. Gabrieli, J. D. (2009). "Dyslexia: A new synergy between education and cognitive neuroscience." <em>Science</em>, 325(5938), 280-283.</p>
                <p>15. McNulty, M. A. (2003). "Dyslexia and the life course." <em>Journal of Learning Disabilities</em>, 36(4), 363-381.</p>
                <p>16. Peterson, R. L., & Pennington, B. F. (2015). "Developmental dyslexia." <em>Annual Review of Clinical Psychology</em>, 11, 283-307.</p>
                <p>17. Norton, E. S., & Wolf, M. (2012). "Rapid automatized naming (RAN) and reading fluency: Implications for understanding and treatment of reading disabilities." <em>Annual Review of Psychology</em>, 63, 427-452.</p>
              </div>
            </div>
