...
export function DyslexiaOverview({ setCurrentArticle, initialTab }: DyslexiaOverviewProps) {
  ...
  const renderReferences = () => {
    // These 4 citations are used in the Introduction, which appears on every tab
    const introRefs = (
      <>
    ...
    if (activeTab === 'what') {
      return (
        <ol className="list-decimal ml-5 text-xs space-y-3 text-slate-600 leading-relaxed">
          {introRefs}
          <li>International Dyslexia Association. (2002). "Definition of dyslexia." Retrieved from https://dyslexiaida.org/definition-of-dyslexia/</li>
    ...
    if (activeTab === 'types') {
      return (
        <ol className="list-decimal ml-5 text-xs space-y-3 text-slate-600 leading-relaxed">
          ...
          <li>Quinn, J. M., & Wagner, R. K. (2015). "Gender differences in reading impairment and in the identification of impaired readers." <i>Journal of Learning Disabilities</i>, 48(4), 433-445.</li>
    ...
    if (activeTab === 'facts') {
      return (
        <ol className="list-decimal ml-5 text-xs space-y-3 text-slate-600 leading-relaxed">
          ...
          <li>Swanson, H. L., Harris, K. R., & Graham, S. (Eds.). (2013). <i>Handbook of learning disabilities</i>. Guilford Press.</li>
        </ol>
      );
    }
  ...
  return (
    <article className="max-w-6xl animate-fadeIn">
      ...
      {/* Introduction - Shared Across All Tabs */}
      <div className="mb-8">
        <p className="mb-4">
        ...
        <div className="space-y-8 animate-fadeIn">
          ...
          <div>
            ...
            <ul className="list-disc ml-6 mb-4">
              <li className="mb-2"><strong>Phonological processing difficulties:</strong> Trouble with the sound structure of language<sup className="text-green-600 font-bold ml-0.5">6</sup></li>
              <li className="mb-2"><strong>Word decoding problems:</strong> Difficulty sounding out written words<sup className="text-green-600 font-bold ml-0.5">7</sup></li>
              <li className="mb-2"><strong>Reading fluency challenges:</strong> Slow, effortful reading even of familiar text<sup className="text-green-600 font-bold ml-0.5">8</sup></li>
              <li className="mb-2"><strong>Spelling difficulties:</strong> Persistent spelling errors despite instruction<sup className="text-green-600 font-bold ml-0.5">9</sup></li>
              <li className="mb-2"><strong>Neurobiological basis:</strong> Differences in brain structure and function related to reading<sup className="text-green-600 font-bold ml-0.5">1</sup></li>
              <li className="mb-2"><strong>Unexpected difficulty:</strong> Reading challenges not explained by intellectual ability, sensory problems, or lack of instruction<sup className="text-green-600 font-bold ml-0.5">1</sup></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="bg-white rounded-md border-2 border-[#0c264d] p-6 mb-4">
              ...
              <div className="text-sm space-y-3">
                <p><strong>✗ Visual problem:</strong> Dyslexia is not primarily a vision problem; it's language-based<sup className="text-green-600 font-bold ml-0.5">6</sup></p>
                <p><strong>✗ Seeing letters backwards:</strong> While letter reversals can occur, this is not the core issue and is common in early literacy for all children<sup className="text-green-600 font-bold ml-0.5">10</sup></p>
                <p><strong>✗ Low intelligence:</strong> Dyslexia occurs across the IQ range; many individuals with dyslexia have average or above-average intelligence<sup className="text-green-600 font-bold ml-0.5">11</sup></p>
                <p><strong>✗ Laziness:</strong> Reading difficulties are neurologically based, not due to lack of effort<sup className="text-green-600 font-bold ml-0.5">12</sup></p>
                <p><strong>✗ Something you outgrow:</strong> Dyslexia is lifelong, though individuals can learn to read and manage challenges effectively<sup className="text-green-600 font-bold ml-0.5">13</sup></p>
                <p><strong>✗ Rare:</strong> Dyslexia is common, affecting millions of people worldwide<sup className="text-green-600 font-bold ml-0.5">14</sup></p>
              </div>
            </div>
          </div>
        </div>
      ...
      {activeTab === 'types' && (
        <div className="space-y-8 animate-fadeIn">
          ...
          <div>
            ...
            <ul className="list-disc ml-6 mb-4">
              <li className="mb-2"><strong>Prevalence:</strong> Dyslexia affects approximately 5-10% of the population, with some estimates as high as 15-20%<sup className="text-green-600 font-bold ml-0.5">5</sup></li>
              <li className="mb-2"><strong>Most common learning disability:</strong> Dyslexia represents 80% of all learning disabilities<sup className="text-green-600 font-bold ml-0.5">6</sup></li>
              <li className="mb-2"><strong>Cross-linguistic:</strong> Dyslexia occurs across all languages and writing systems, though manifestation may vary<sup className="text-green-600 font-bold ml-0.5">7</sup></li>
              <li className="mb-2"><strong>Socioeconomic distribution:</strong> Affects individuals across all socioeconomic levels<sup className="text-green-600 font-bold ml-0.5">8</sup></li>
              <li className="mb-2"><strong>Gender:</strong> Historically thought to be more common in males, but recent research suggests similar rates in males and females; girls may be under-identified<sup className="text-green-600 font-bold ml-0.5">9</sup></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="mb-4">
              Dyslexia exists on a continuum of severity, and its manifestation varies among individuals:<sup className="text-green-600 font-bold ml-0.5">10</sup>
            </p>
            ...
            <ul className="list-disc ml-6 mb-4">
              ...
              <li className="mb-2"><strong>Severe:</strong> Persistent, substantial difficulties despite appropriate intervention; may require extensive accommodations throughout life<sup className="text-green-600 font-bold ml-0.5">11</sup></li>
            </ul>

            <h3 className="text-[#0c264d] font-bold mb-3 text-lg">Individual Variation</h3>
            <p className="mb-4">
              No two individuals with dyslexia are exactly alike. Variation occurs in:<sup className="text-green-600 font-bold ml-0.5">12</sup>
            </p>
            <ul className="list-disc ml-6 mb-4">
          ...
          <div>
            ...
            <p className="mb-4">
              Dyslexia frequently co-occurs with other conditions:<sup className="text-green-600 font-bold ml-0.5">13</sup>
            </p>
            <ul className="list-disc ml-6 mb-4">
              <li className="mb-2"><strong>ADHD:</strong> 25-40% of individuals with dyslexia also have ADHD<sup className="text-green-600 font-bold ml-0.5">14</sup></li>
              <li className="mb-2"><strong>Dysgraphia:</strong> Writing difficulties often co-occur with dyslexia<sup className="text-green-600 font-bold ml-0.5">15</sup></li>
              <li className="mb-2"><strong>Dyscalculia:</strong> Some individuals have both reading and math learning disabilities<sup className="text-green-600 font-bold ml-0.5">16</sup></li>
              <li className="mb-2"><strong>Anxiety and depression:</strong> Higher rates due to academic struggles and negative experiences<sup className="text-green-600 font-bold ml-0.5">17</sup></li>
              <li className="mb-2"><strong>Language disorders:</strong> Broader oral language difficulties may be present<sup className="text-green-600 font-bold ml-0.5">18</sup></li>
            </ul>
          </div>
        </div>
      )}
        ...
        <div className="space-y-8 animate-fadeIn">
          ...
          <div>
            ...
            <ul className="list-disc ml-6 mb-4">
              ...
              <li className="mb-2"><strong>Phonological processing:</strong> Connecting letters to sounds (phonemes)<sup className="text-green-600 font-bold ml-0.5">3</sup></li>
              <li className="mb-2"><strong>Orthographic processing:</strong> Recognizing spelling patterns and whole words<sup className="text-green-600 font-bold ml-0.5">4</sup></li>
              <li className="mb-2"><strong>Semantic processing:</strong> Accessing word meanings<sup className="text-green-600 font-bold ml-0.5">5</sup></li>
              <li className="mb-2"><strong>Working memory:</strong> Holding information while processing text<sup className="text-green-600 font-bold ml-0.5">6</sup></li>
            </ul>
            ...
            <p className="mb-4">
              ...
              reading tasks:<sup className="text-green-600 font-bold ml-0.5">7</sup>
            </p>
            <ul className="list-disc ml-6 mb-4">
              <li className="mb-2"><strong>Underactivation:</strong> Reduced activity in left hemisphere regions typically involved in reading, particularly in the parieto-temporal and occipito-temporal areas<sup className="text-green-600 font-bold ml-0.5">8</sup></li>
              <li className="mb-2"><strong>Compensatory activation:</strong> Increased reliance on other brain regions, such as frontal areas and right hemisphere regions<sup className="text-green-600 font-bold ml-0.5">9</sup></li>
              <li className="mb-2"><strong>White matter differences:</strong> Atypical connectivity in neural pathways supporting reading<sup className="text-green-600 font-bold ml-0.5">10</sup></li>
              <li className="mb-2"><strong>Phonological circuit disruption:</strong> Particular difficulty in the neural systems that connect letters to sounds<sup className="text-green-600 font-bold ml-0.5">11</sup></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="mb-4">
              The most well-established explanation for dyslexia is the phonological deficit hypothesis.<sup className="text-green-600 font-bold ml-0.5">12</sup> This 
            ...
            <p className="mb-4">
              Phonological processing involves several related skills:<sup className="text-green-600 font-bold ml-0.5">13</sup>
            </p>
            <ul className="list-disc ml-6 mb-4">
              ...
              <li className="mb-2"><strong>Rapid automatized naming (RAN):</strong> Speed of retrieving phonological codes from long-term memory<sup className="text-green-600 font-bold ml-0.5">14</sup></li>
            </ul>

            <h3 className="text-[#0c264d] font-bold mb-3 text-lg">How Phonological Deficits Affect Reading</h3>
            <p className="mb-4">
              When phonological processing is impaired:<sup className="text-green-600 font-bold ml-0.5">15</sup>
            </p>
            <ul className="list-disc ml-6 mb-4">
          ...
          <div>
            ...
            <p className="mb-4">
              While dyslexia presents challenges, many individuals with dyslexia also demonstrate notable strengths:<sup className="text-green-600 font-bold ml-0.5">16</sup>
            </p>
            <ul className="list-disc ml-6 mb-4">
              <li className="mb-2"><strong>Creative thinking:</strong> Strong ability to think outside the box and generate novel ideas<sup className="text-green-600 font-bold ml-0.5">17</sup></li>
              <li className="mb-2"><strong>Visual-spatial reasoning:</strong> Enhanced ability to think in pictures and mentally manipulate 3D objects<sup className="text-green-600 font-bold ml-0.5">18</sup></li>
              <li className="mb-2"><strong>Big-picture thinking:</strong> Ability to see connections and patterns others might miss<sup className="text-green-600 font-bold ml-0.5">19</sup></li>
              <li className="mb-2"><strong>Problem-solving:</strong> Innovative approaches to challenges<sup className="text-green-600 font-bold ml-0.5">20</sup></li>
              <li className="mb-2"><strong>Narrative reasoning:</strong> Strength in storytelling and understanding complex narratives<sup className="text-green-600 font-bold ml-0.5">21</sup></li>
              <li className="mb-2"><strong>Resilience:</strong> Persistence and determination developed through overcoming challenges<sup className="text-green-600 font-bold ml-0.5">22</sup></li>
            </ul>
            <p className="mb-4">
              Many successful individuals in diverse fields—including entrepreneurs, artists, scientists, and leaders—have dyslexia.<sup className="text-green-600 font-bold ml-0.5">23</sup>
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mb-4">
              Understanding dyslexia is crucial because:<sup className="text-green-600 font-bold ml-0.5">24</sup>
            </p>
            <ul className="list-disc ml-6 mb-4">
              <li className="mb-2"><strong>Early identification matters:</strong> Early intervention leads to better outcomes<sup className="text-green-600 font-bold ml-0.5">25</sup></li>
              <li className="mb-2"><strong>Appropriate instruction is essential:</strong> Individuals with dyslexia need structured, explicit, multisensory reading instruction<sup className="text-green-600 font-bold ml-0.5">26</sup></li>
              <li className="mb-2"><strong>Accommodations enable success:</strong> With appropriate support, individuals with dyslexia can achieve their potential<sup className="text-green-600 font-bold ml-0.5">27</sup></li>
              <li className="mb-2"><strong>Self-understanding is empowering:</strong> Understanding dyslexia helps individuals advocate for themselves and develop effective strategies<sup className="text-green-600 font-bold ml-0.5">28</sup></li>
              <li className="mb-2"><strong>Reduces negative impact:</strong> Proper identification and support prevent secondary issues like low self-esteem and school dropout<sup className="text-green-600 font-bold ml-0.5">29</sup></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="mb-4">
              ...
              strong reading skills and succeed academically, professionally, and personally.<sup className="text-green-600 font-bold ml-0.5">30</sup>
            </p>
            
            <p className="mb-4">
              The key is recognizing dyslexia early, providing evidence-based intervention, celebrating strengths, and 
              fostering an environment where individuals with dyslexia can thrive.<sup className="text-green-600 font-bold ml-0.5">11</sup>
            </p>
          </div>
        </div>
      )}
