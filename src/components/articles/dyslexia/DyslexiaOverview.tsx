...
export function DyslexiaOverview({ setCurrentArticle, initialTab }: DyslexiaOverviewProps) {
  ...
  // Local state makes the tabs instantly switch without relying on the URL
  const [activeTab, setActiveTab] = useState(initialTab || 'what');

  // Dynamic references that change based on the active tab
  const renderReferences = () => {
    ...
    if (activeTab === 'facts') {
      return (
        <ol className="list-decimal ml-5 text-xs space-y-3 text-slate-600 leading-relaxed">
          {introRefs}
          <li>Dehaene, S. (2009). <i>Reading in the brain: The new science of how we read</i>. Penguin.</li>
          <li>Wagner, R. K., & Torgesen, J. K. (1987). "The nature of phonological processing and its causal role in the acquisition of reading skills." <i>Psychological Bulletin</i>, 101(2), 192-212.</li>
          <li>Perfetti, C. (2007). "Reading ability: Lexical quality to comprehension." <i>Scientific Studies of Reading</i>, 11(4), 357-383.</li>
          <li>Swanson, H. L., & Berninger, V. (1995). "The role of working memory in skilled and less skilled readers' comprehension." <i>Intelligence</i>, 21(1), 83-108.</li>
  ...
  return (
    <article className="max-w-6xl animate-fadeIn">
      ...
      {/* Tab Navigation - Uses local state instead of navigate */}
      ...
      {activeTab === 'what' && (
        <div className="space-y-8 animate-fadeIn">
          ...
          <div className="mt-8">
            <h2 className="text-[#0c264d] mb-4 text-2xl border-b border-[#ffd166] pb-2 inline-block">Common Misconceptions</h2>
            
            <div className="bg-white rounded-md border-2 border-[#0c264d] p-6 mb-4 shadow-sm">
              <h3 className="text-center text-[#0c264d] mb-6 text-lg">What Dyslexia Is NOT:</h3>
      ...
      {activeTab === 'types' && (
        <div className="space-y-8 animate-fadeIn">
          {/* Prevalence Section */}
          <div>
            <h2 className="text-[#0c264d] mb-4 text-2xl border-b border-[#ffd166] pb-2 inline-block">How Common is Dyslexia?</h2>
            
            <ul className="list-disc ml-6 mb-4 text-gray-700 space-y-2">
              <li><strong>Prevalence:</strong> Dyslexia affects approximately 5-10% of the population, with some estimates as high as 15-20%.<sup className="text-green-600 font-bold ml-0.5">5</sup></li>
              <li><strong>Most common learning disability:</strong> Dyslexia represents 80% of all learning disabilities.<sup className="text-green-600 font-bold ml-0.5">6</sup></li>
              <li><strong>Cross-linguistic:</strong> Dyslexia occurs across all languages and writing systems, though manifestation may vary.<sup className="text-green-600 font-bold ml-0.5">7</sup></li>
              <li><strong>Socioeconomic distribution:</strong> Affects individuals across all socioeconomic levels.<sup className="text-green-600 font-bold ml-0.5">8</sup></li>
              <li><strong>Gender:</strong> Historically thought to be more common in males, but recent research suggests similar rates in males and females; girls may be under-identified.<sup className="text-green-600 font-bold ml-0.5">9</sup></li>
            </ul>
          </div>

          {/* Spectrum and Severity Section */}
          <div>
            <h2 className="text-[#0c264d] mb-4 text-2xl border-b border-[#ffd166] pb-2 inline-block">Dyslexia as a Spectrum</h2>
            ...
            <h3 className="text-[#0c264d] mb-3 text-lg">Severity Levels</h3>
            <ul className="list-disc ml-6 mb-6 text-gray-700 space-y-2">
              ...
              <li><strong>Severe:</strong> Persistent, substantial difficulties despite appropriate intervention; may require extensive accommodations throughout life.<sup className="text-green-600 font-bold ml-0.5">11</sup></li>
            </ul>

            <h3 className="text-[#0c264d] mb-3 text-lg">Individual Variation</h3>
            <p className="mb-4 text-gray-700">
          ...
          <div>
            <h2 className="text-[#0c264d] mb-4 text-2xl border-b border-[#ffd166] pb-2 inline-block">Co-occurring Conditions</h2>
            
            <p className="mb-4 text-gray-700">
              Dyslexia frequently co-occurs with other conditions:<sup className="text-green-600 font-bold ml-0.5">13</sup>
            </p>
            <ul className="list-disc ml-6 mb-4 text-gray-700 space-y-2">
              <li><strong>ADHD:</strong> 25-40% of individuals with dyslexia also have ADHD.<sup className="text-green-600 font-bold ml-0.5">14</sup></li>
              <li><strong>Dysgraphia:</strong> Writing difficulties often co-occur with dyslexia.<sup className="text-green-600 font-bold ml-0.5">15</sup></li>
              <li><strong>Dyscalculia:</strong> Some individuals have both reading and math learning disabilities.<sup className="text-green-600 font-bold ml-0.5">16</sup></li>
              <li><strong>Anxiety and depression:</strong> Higher rates due to academic struggles and negative experiences.<sup className="text-green-600 font-bold ml-0.5">17</sup></li>
              <li><strong>Language disorders:</strong> Broader oral language difficulties may be present.<sup className="text-green-600 font-bold ml-0.5">18</sup></li>
            </ul>
          </div>
        </div>
      )}
      ...
      {activeTab === 'facts' && (
        <div className="space-y-8 animate-fadeIn">
          ...
          <div>
            <h2 className="text-[#0c264d] mb-4 text-2xl border-b border-[#ffd166] pb-2 inline-block">Understanding the Reading Brain</h2>
            ...
            <h3 className="text-[#0c264d] mb-3 text-lg">How Typical Reading Works</h3>
            <p className="mb-4 text-gray-700">
              Reading is not a natural process for the human brain—it must be taught and learned.<sup className="text-green-600 font-bold ml-0.5">5</sup> Proficient 
            ...
            <ul className="list-disc ml-6 mb-6 text-gray-700 space-y-1">
              ...
              <li><strong>Phonological processing:</strong> Connecting letters to sounds (phonemes)<sup className="text-green-600 font-bold ml-0.5">6</sup></li>
              <li><strong>Orthographic processing:</strong> Recognizing spelling patterns and whole words<sup className="text-green-600 font-bold ml-0.5">7</sup></li>
              <li><strong>Semantic processing:</strong> Accessing word meanings<sup className="text-green-600 font-bold ml-0.5">5</sup></li>
              <li><strong>Working memory:</strong> Holding information while processing text<sup className="text-green-600 font-bold ml-0.5">8</sup></li>
            </ul>

            <h3 className="text-[#0c264d] mb-3 text-lg mt-8 clear-both">Differences in Dyslexia</h3>
            <p className="mb-4 text-gray-700">
              Brain imaging studies show that individuals with dyslexia show different patterns of brain activation during 
              reading tasks:<sup className="text-green-600 font-bold ml-0.5">9</sup>
            </p>
            <ul className="list-disc ml-6 mb-4 text-gray-700 space-y-2">
              <li><strong>Underactivation:</strong> Reduced activity in left hemisphere regions typically involved in reading, particularly in the parieto-temporal and occipito-temporal areas.<sup className="text-green-600 font-bold ml-0.5">10</sup></li>
              <li><strong>Compensatory activation:</strong> Increased reliance on other brain regions, such as frontal areas and right hemisphere regions.<sup className="text-green-600 font-bold ml-0.5">11</sup></li>
              <li><strong>White matter differences:</strong> Atypical connectivity in neural pathways supporting reading.<sup className="text-green-600 font-bold ml-0.5">12</sup></li>
              <li><strong>Phonological circuit disruption:</strong> Particular difficulty in the neural systems that connect letters to sounds.<sup className="text-green-600 font-bold ml-0.5">13</sup></li>
            </ul>
          </div>

          {/* Phonological Core Deficit Section */}
          <div>
            <h2 className="text-[#0c264d] mb-4 text-2xl border-b border-[#ffd166] pb-2 inline-block">The Phonological Core Deficit</h2>
            
            <p className="mb-4 text-gray-700">
              The most well-established explanation for dyslexia is the phonological deficit hypothesis.<sup className="text-green-600 font-bold ml-0.5">14</sup> This 
              theory proposes that dyslexia stems from a specific impairment in the representation, storage, and/or retrieval 
              of speech sounds.
            </p>

            <h3 className="text-[#0c264d] mb-3 text-lg">What is Phonological Processing?</h3>
            <p className="mb-4 text-gray-700">
              Phonological processing involves several related skills:<sup className="text-green-600 font-bold ml-0.5">15</sup>
            </p>
            <ul className="list-disc ml-6 mb-6 text-gray-700 space-y-2">
              ...
              <li><strong>Rapid automatized naming (RAN):</strong> Speed of retrieving phonological codes from long-term memory<sup className="text-green-600 font-bold ml-0.5">16</sup></li>
            </ul>

            <h3 className="text-[#0c264d] mb-3 text-lg">How Phonological Deficits Affect Reading</h3>
            <p className="mb-4 text-gray-700">
              When phonological processing is impaired:<sup className="text-green-600 font-bold ml-0.5">17</sup>
            </p>
            <ul className="list-disc ml-6 mb-4 text-gray-700 space-y-1">
          ...
          {/* Strengths Section */}
          <div>
            <h2 className="text-[#0c264d] mb-4 text-2xl border-b border-[#ffd166] pb-2 inline-block">Dyslexia and Strengths</h2>
            ...
            <p className="mb-4 text-gray-700">
              While dyslexia presents challenges, many individuals with dyslexia also demonstrate notable strengths:<sup className="text-green-600 font-bold ml-0.5">18</sup>
            </p>
            <ul className="list-disc ml-6 mb-6 text-gray-700 space-y-2">
              <li><strong>Creative thinking:</strong> Strong ability to think outside the box and generate novel ideas.<sup className="text-green-600 font-bold ml-0.5">19</sup></li>
              <li><strong>Visual-spatial reasoning:</strong> Enhanced ability to think in pictures and mentally manipulate 3D objects.<sup className="text-green-600 font-bold ml-0.5">20</sup></li>
              <li><strong>Big-picture thinking:</strong> Ability to see connections and patterns others might miss.<sup className="text-green-600 font-bold ml-0.5">21</sup></li>
              <li><strong>Problem-solving:</strong> Innovative approaches to challenges.<sup className="text-green-600 font-bold ml-0.5">22</sup></li>
              <li><strong>Narrative reasoning:</strong> Strength in storytelling and understanding complex narratives.<sup className="text-green-600 font-bold ml-0.5">23</sup></li>
              <li><strong>Resilience:</strong> Persistence and determination developed through overcoming challenges.<sup className="text-green-600 font-bold ml-0.5">24</sup></li>
            </ul>
            <p className="mb-4 text-gray-700 clear-both">
              Many successful individuals in diverse fields—including entrepreneurs, artists, scientists, and leaders—have dyslexia.<sup className="text-green-600 font-bold ml-0.5">25</sup>
            </p>
          </div>

          {/* Importance of Early Identification Section */}
          <div>
            <h2 className="text-[#0c264d] mb-4 text-2xl border-b border-[#ffd166] pb-2 inline-block">The Importance of Understanding Dyslexia</h2>
            
            <p className="mb-4 text-gray-700">
              Understanding dyslexia is crucial because:<sup className="text-green-600 font-bold ml-0.5">26</sup>
            </p>
            <ul className="list-disc ml-6 mb-4 text-gray-700 space-y-2">
              <li><strong>Early identification matters:</strong> Early intervention leads to better outcomes.<sup className="text-green-600 font-bold ml-0.5">27</sup></li>
              <li><strong>Appropriate instruction is essential:</strong> Individuals with dyslexia need structured, explicit, multisensory reading instruction.<sup className="text-green-600 font-bold ml-0.5">28</sup></li>
              <li><strong>Accommodations enable success:</strong> With appropriate support, individuals with dyslexia can achieve their potential.<sup className="text-green-600 font-bold ml-0.5">29</sup></li>
              <li><strong>Self-understanding is empowering:</strong> Understanding dyslexia helps individuals advocate for themselves and develop effective strategies.<sup className="text-green-600 font-bold ml-0.5">30</sup></li>
              <li><strong>Reduces negative impact:</strong> Proper identification and support prevent secondary issues like low self-esteem and school dropout.<sup className="text-green-600 font-bold ml-0.5">31</sup></li>
            </ul>
          </div>

          {/* Looking Forward Section */}
          <div>
            <h2 className="text-[#0c264d] mb-4 text-2xl border-b border-[#ffd166] pb-2 inline-block">Moving Forward</h2>
            ...
            <p className="mb-4 text-gray-700">
              ...
              strong reading skills and succeed academically, professionally, and personally.<sup className="text-green-600 font-bold ml-0.5">32</sup>
            </p>
            
            <p className="mb-4 text-gray-700">
              The key is recognizing dyslexia early, providing evidence-based intervention, celebrating strengths, and 
              fostering an environment where individuals with dyslexia can thrive.<sup className="text-green-600 font-bold ml-0.5">13</sup>
            </p>
          </div>
        </div>
      )}
