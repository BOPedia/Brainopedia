    ...
    <article className="max-w-6xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <ul className="list-disc ml-6 mb-4">
            <li className="mb-2">Structured groups with peers<sup<2/>sup></li>
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            <li className="mb-2">Understanding figurative language, idioms, sarcasm<sup<3/>sup></li>
        ...
        <div>
          ...
          <ul className="list-disc ml-6 mb-4">
            <li className="mb-2"><strong>Extended time:</strong> For tests and assignments<sup<4/>sup></li>
            ...
            <li className="mb-2"><strong>Preferential seating:</strong> Near teacher, away from distractions<sup<5/>sup></li>
          </ul>
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            <li className="mb-2">Written schedules and checklists<sup<6/>sup></li>
