      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div className="space-y-6">
          <p>
            ...
            and varies in severity from person to person.<sup>12</sup>
          </p>
