    ...
    <article className="max-w-6xl">
      ...
      <section className="mt-12 pt-6 border-t-2 border-gray-300">
        ...
        <div className="text-sm space-y-2">
          ...
          <p>[11] Reis, S. M., Westberg, K. L., Kulikowich, J., Caillard, F., Hébert, T., Plucker, J., ... & Smist, J. M. (1993). "Why not let high ability students start school in January? The curriculum compacting study." <em>Research Monograph 93106</em>. Storrs: University of Connecticut, National Research Center on the Gifted and Talented.</p>
          ...
          <p>[64] Campbell, J. R., Wagner, H., & Walberg, H. J. (2000). "Academic competitions and programs designed to challenge the exceptionally talented." In K. A. Heller, F. J. Mönks, R. J. Sternberg, & R. F. Subotnik (Eds.), <em>International handbook of giftedness and talent</em> (2nd ed., pp. 523-535). Amsterdam: Elsevier.</p>
          ...
          <p>[66] Hébert, T. P., & Olenchak, F. R. (2000). "Mentors for gifted underachieving males: Developing potential and realizing promise." <em>Gifted Child Quarterly</em>, 44(3), 196-207.</p>
