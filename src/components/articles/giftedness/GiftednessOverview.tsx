    ...
    <article className="max-w-6xl">
      ...
      <section className="mt-12 pt-6 border-t-2 border-gray-300">
        ...
        <div className="text-sm space-y-2">
          ...
          <p>[56] Tucker-Drob, E. M., & Bates, T. C. (2016). "Large cross-national differences in gene × socioeconomic status interaction on intelligence." <em>Psychological Science</em>, 27(2), 138-149.</p>
