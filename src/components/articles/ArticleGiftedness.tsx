      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="space-y-6">
          <p>
            ...
            that fundamentally shape how individuals perceive and interact with the world.<sup>12</sup>
          </p>
      ...
      <div className="space-y-8 mt-20 clear-both">
        <section id="overview" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <p className="mb-4">
            ...
            that giftedness exists across all cultural, ethnic, and socioeconomic backgrounds.<sup>16</sup> Importantly, 
