        ...
        <div className="bg-red-200 text-[#0c264d] p-6 rounded-2xl flex items-start gap-4 shadow-xl">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed font-medium text-[#0c264d]">
              When updating text or citations, ALWAYS preserve imported graphics. Do NOT remove <code className="bg-white px-1 rounded text-[#0c264d]">ImageWithFallback</code> components or change image placements unless explicitly requested.
            </p>
          </div>
        </div>
      </section>
