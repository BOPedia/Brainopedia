      ...
      <>
        <div>
          ...
          <p className="mb-4">
            ...
            imbalances, and certain environmental exposures during critical developmental periods<sup style={{color: '#10b981'}}>12</sup>.
          </p>
        </div>
        ...
        <div className="clear-both pt-6">
          ...
          <p className="mb-4">
            Modern research increasingly recognizes that genes and environment interact in complex ways<sup style={{color: '#10b981'}}>13</sup>. Someone 
        ...
        <div className="bg-white p-6 rounded-lg mt-8">
          ...
          <div className="text-sm space-y-2 mb-4">
            ...
            <p><sup style={{color: '#10b981'}}>12</sup> Faraone, S. V., & Larsson, H. (2019). "Genetics of attention deficit hyperactivity disorder." <em>Molecular Psychiatry</em>, 24(4), 562-575.; Cortese, S., et al. (2012). "Toward systems neuroscience of ADHD: A meta-analysis of 55 fMRI studies." <em>American Journal of Psychiatry</em>, 169(10), 1038-1055.</p>
            <p><sup style={{color: '#10b981'}}>13</sup> Nigg, J. T., et al. (2010). "Gene-environment interactions and ADHD: A review of the literature." <em>Journal of the American Academy of Child & Adolescent Psychiatry</em>, 49(5), 432-445.; Thapar, A., et al. (2013). "Gene-environment interplay in attention-deficit hyperactivity disorder and the importance of a developmental perspective." <em>British Journal of Psychiatry</em>, 202(6), 414-415.</p>
          </div>
    ...
    return (
      <div>
        ...
        <p className="mb-4">
          ...
          adulthood.<sup className="text-[#10b981]">12</sup><sup className="text-[#10b981]">13</sup>
        </p>
        ...
        <p className="mb-4">
          ...
          analyzing data from over 38,000 individuals with ADHD and 186,000 controls.<sup className="text-[#10b981]">14</sup> This groundbreaking 
        ...
        <p className="mb-4">
          ...
          have also contributed to identifying genetic variants associated with symptom severity.<sup className="text-[#10b981]">16</sup>
        </p>
    ...
    return (
      <div>
        ...
        <p className="mb-4">
          ...
          particularly in frontal, temporal, and cingulate regions.<sup className="text-[#10b981]">12</sup> The findings support the concept 
        ...
        <ul className="list-disc ml-6 mb-4">
          <li className="mb-2"><strong>Total brain volume:</strong> Meta-analyses confirm smaller total brain volume and intracranial volume in children with ADHD, with these differences being most prominent in childhood<sup className="text-[#10b981]">13</sup></li>
          ...
          <li className="mb-2"><strong>Cortical thickness:</strong> Thinner cortex in multiple regions, particularly in prefrontal and temporal areas, with some studies showing normalization in adulthood<sup className="text-[#10b981]">14</sup></li>
          ...
          <li className="mb-2"><strong>White matter microstructure:</strong> Differences in white matter organization affecting neural connectivity between brain regions, particularly in pathways connecting frontal regions to other brain areas<sup className="text-[#10b981]">16</sup><sup className="text-[#10b981]">7</sup></li>
        </ul>
    ...
    return (
      <div>
        ...
        <p className="mb-4">
          ...
          between neurons.<sup className="text-[#10b981]">12</sup> This is significant because stimulant medications work primarily by blocking 
        ...
        <p className="mb-4">
          ...
          (particularly DRD4 and DRD5) associated with ADHD.<sup className="text-[#10b981]">13</sup> These genetic variations may influence how 
        ...
        <p className="mb-4">
          ...
          tasks, and may engage in reward-seeking behaviors.<sup className="text-[#10b981]">14</sup> Recent research suggests that ADHD 
        ...
        <p className="mb-4">
          ...
          much norepinephrine can impair these functions.<sup className="text-[#10b981]">16</sup> This helps explain why both stimulant 
        ...
        <p className="mb-4">
          ...
          in the synapse, helping normalize signaling in underactive circuits.<sup className="text-[#10b981]">16</sup> Non-stimulant medications 
    ...
    return (
      <div>
        ...
        <p className="mb-4">
          ...
          of ADHD.<sup className="text-[#10b981]">12</sup> Recent research using sibling comparison designs suggests that while some of this 
          association may be due to shared familial/genetic factors, there likely remains a direct causal effect of 
          prenatal nicotine exposure on ADHD risk.<sup className="text-[#10b981]">13</sup> The mechanisms may involve nicotine's effects on 
        ...
        <p className="mb-4">
          ...
          attention problems and hyperactivity similar to ADHD.<sup className="text-[#10b981]">14</sup> Even moderate alcohol exposure during 
        ...
        <p className="mb-4">
          ...
          effects on the developing fetal stress response systems and brain development.<sup className="text-[#10b981]">16</sup> Maternal depression 
