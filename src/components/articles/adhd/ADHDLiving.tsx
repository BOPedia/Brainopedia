      ...
      <>
        ...
        <div className="clear-both pt-6">
          ...
          <p className="mb-4">
            ...
            flexibility associated with ADHD may contribute to creative achievement.<sup>12</sup>
          </p>
    ...
    return (
      <div>
        ...
        <p className="mb-4">
          ...
          behaviors, including more harsh and lax parenting and slightly less positive parenting.<sup>12</sup> However, 
