...
export function ADHDSymptomsTabCore({ setCurrentArticle }: TabCoreProps) {
  return (
    <div className="space-y-8 w-full">
      ...
      <div className="bg-[#f0f9ff] p-6 rounded-lg space-y-6">
        <h2 className="text-[#0c264d] font-bold text-2xl">The 18 DSM-5 Diagnostic Criteria</h2>
        
        <div className="bg-[#e8f5e8] border-l-4 border-[#0c264d] p-4 rounded">
          <p className="text-sm mb-3 font-bold text-[#0c264d]">
        ...
        {/* Bottom Callout */}
        <div className="bg-[#f0e6ff] border-l-4 border-[#0c264d] p-4 rounded space-y-3">
