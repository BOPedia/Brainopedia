      ...
      <div className="bg-white bg-opacity-50 p-6 rounded-lg shadow-inner">
        ...
        <div className="mb-6">
          ...
          <div className="text-xs space-y-3 text-slate-600 leading-relaxed" style={{ textIndent: 0 }}>
            <p>
              1. American Psychiatric Association. (2022). <i>Diagnostic and Statistical Manual of Mental Disorders</i> (5th ed., text rev.). Washington, DC: American Psychiatric Association.
            </p>
          </div>
        </div>
