            ...
            <div className="bg-white p-5 rounded-md border-l-4 border-[#2abcd4] shadow-sm mb-6">
              ...
              <div className="bg-[#f0f9ff] p-4 rounded mb-3">
                ...
                <div className="text-sm space-y-2">
                  ...
                  organizational skills of a 20-year-old.<sup className="text-[#10b981]">12</sup></p>
                  <p><strong>Prevalence:</strong> Studies show that 40–60% of adults with ADHD experience significant challenges in 
                  time management and organization.<sup className="text-[#10b981]">12</sup></p>
            ...
            <div className="bg-white p-5 rounded-md border-l-4 border-[#2abcd4] shadow-sm mb-6">
              ...
              <div className="bg-[#f0f9ff] p-4 rounded mb-3">
                ...
                <div className="text-sm space-y-2">
                  ...
                  correct trials of cognitive tasks, suggesting it helps sustain attention during challenging work.<sup className="text-[#10b981]">13</sup></p>
                  ...
                  in adults during meetings compared to forced stillness.<sup className="text-[#10b981]">13</sup></p>
                </div>
              </div>
            ...
            <div className="bg-white p-5 rounded-md border-l-4 border-[#2abcd4] shadow-sm mb-6">
              ...
              <div className="bg-[#f0f9ff] p-4 rounded mb-3">
                ...
                <div className="text-sm space-y-2">
                  ...
                  <p><strong>High Prevalence:</strong> One study found that 62% of people with ADHD meet the clinical criteria for fatigue.<sup className="text-[#10b981]">14</sup></p>
                  <p><strong>Executive Load:</strong> Research indicates that executive function deficits, particularly in self-management 
                  and problem-solving, directly mediate the relationship between ADHD and job burnout.<sup className="text-[#10b981]">14</sup></p>
