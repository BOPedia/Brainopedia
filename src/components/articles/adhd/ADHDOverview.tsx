    ...
    <article className="max-w-full w-full">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="mb-4">
            According to the DSM-5-TR, ADHD is diagnosed in one of three presentations, based on the predominant symptom pattern over the past six months:<sup className="text-[#10b981]">13</sup>
          </p>
        ...
        <div>
          ...
          <div className="bg-white rounded-md border-2 border-[#0c264d] p-6 md:float-right md:ml-6 mb-4 w-full md:w-96">
            ...
            <div className="mb-6 pb-6 border-b-2 border-gray-200">
              ...
              <div className="text-center mt-2 text-sm text-gray-600">2:1 to 3:1 ratio<sup className="text-[#10b981]">14</sup></div>
            </div>
            ...
            <div>
              ...
              <div className="bg-[#0A9DC4] text-white rounded p-3 text-center">
                ...
                <div className="text-sm">50-75% of cases<sup className="text-[#10b981]">14</sup></div>
              </div>
            </div>
          </div>
          ...
          <p className="mb-4">
            ...
            community samples.<sup className="text-[#10b981]">14</sup> However, this gap narrows in adulthood, and many experts believe ADHD is 
        ...
        <div>
          ...
          <div className="bg-white rounded-md border-2 border-[#0c264d] p-6 md:float-right md:ml-6 mb-4 w-full md:w-[420px]">
            ...
            <div>
              <div className="text-sm text-center mb-3 text-[#0c264d] font-bold">Common Co-occurring Conditions<sup className="text-[#10b981]">16</sup></div>
