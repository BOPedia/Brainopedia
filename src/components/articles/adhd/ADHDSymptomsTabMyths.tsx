  ...
  return (
    <>
          <div className="bg-[#f0f9ff] p-6 rounded-lg">
            ...
            <div className="clear-both bg-white p-5 rounded-md border-l-4 border-[#0c264d] shadow-sm mb-6">
                ...
                <div className="border-l-2 border-[#2abcd4] pl-3">
                  <div className="flex flex-col sm:flex-row gap-4 mt-2">
                    <ImageWithFallback
                      ...
                      className="w-48 h-auto rounded-md border border-gray-300 shrink-0"
                    />
                    <div className="text-sm">
            ...
            <div className="bg-white p-5 rounded-md border-l-4 border-[#0c264d] shadow-sm mb-6">
              ...
              <div className="space-y-4">
                <div className="border-l-2 border-[#2abcd4] pl-3">
                  ...
                  <div className="text-sm">
                    This IS common in ADHD (~70% experience it)<sup style={{color: '#10b981'}}>10</sup> but it's NOT one of the 18 DSM-5 diagnostic criteria<sup style={{color: '#10b981'}}>12</sup>. 
