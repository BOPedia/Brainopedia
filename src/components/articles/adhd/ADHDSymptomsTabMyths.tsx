...
import { AlertCircle, HelpCircle, Search, Brain, Scale, ShieldAlert, Info } from 'lucide-react';
    ...
    <>
      <div className="bg-[#f0f9ff] p-6 rounded-lg">
        <div className="flex items-center gap-3 mb-4">
          <HelpCircle className="text-[#0c264d] w-8 h-8" />
          <h2 className="text-[#0c264d] font-bold text-2xl m-0">Myths & Misconceptions About ADHD</h2>
        </div>
        
        <div className="flex justify-center my-6">
          <ImageWithFallback 
            src="/images/adhd-not-actually-adhd.png"
        ...
        <div className="bg-[#ffd166] border-l-4 border-[#0c264d] p-4 rounded mb-8">
          <div className="flex gap-3">
            <Info className="text-[#0c264d] w-5 h-5 shrink-0 mt-0.5" />
            <p className="text-sm">
        ...
        {/* NOT Actually ADHD */}
        <div className="bg-white p-5 rounded-md border-l-4 border-[#0c264d] shadow-sm mb-8">
          <div className="flex items-center gap-2 mb-4">
            <ShieldAlert className="text-[#0c264d] w-5 h-5" />
            <h3 className="text-[#0c264d] font-bold text-lg m-0">NOT Actually ADHD (or Not Diagnostic Criteria)</h3>
          </div>
        ...
        <div className="flex justify-center my-8">
          <ImageWithFallback 
            src="/images/adhd-research-desk.png"
            alt="Research desk - scientific perspective on ADHD"
            className="w-64 h-auto rounded-md border border-gray-300 shadow-sm"
          />
        </div>
        ...
        <div className="bg-white p-5 rounded-md border-l-4 border-[#0c264d] shadow-sm mb-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-[#0c264d] font-bold text-lg m-0">Needs MUCH More Research / Overstated</h3>
          </div>
        ...
        <div className="bg-white p-5 rounded-md border-l-4 border-[#0c264d] shadow-sm mb-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-[#0c264d] font-bold text-lg m-0">Misattributed or Over-Romanticized</h3>
          </div>
        ...
        <div className="bg-white p-5 rounded-md border-l-4 border-[#0c264d] shadow-sm mb-8">
          <div className="flex items-center gap-2 mb-4">
            <AlertCircle className="text-[#0c264d] w-5 h-5" />
            <h3 className="text-[#0c264d] font-bold text-lg m-0">Real But Overstated/Oversimplified</h3>
          </div>
        ...
        <div className="bg-[#ffd166] border-l-4 border-[#0c264d] p-4 rounded">
          <div className="flex gap-3">
            ...
            <div>
              ...
              <ul className="text-sm list-disc space-y-1 ml-4">
      ...
      <div className="bg-white p-6 rounded-lg border-l-4 border-[#2abcd4] mt-8">
        <div className="flex items-center gap-3 mb-4">
          <Brain className="text-[#0c264d] w-7 h-7" />
          <h2 className="text-[#0c264d] font-bold text-2xl m-0">References</h2>
        </div>
