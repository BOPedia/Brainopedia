      ...
      <div className="space-y-8 mt-20 clear-both">
        <section id="overview" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <img 
            ...
            alt="Abstract artistic representation of the ADHD experience - showing complexity, depth, and multifaceted nature of attention and focus"
        ...
        <section id="characteristics" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <img 
            src={definingAdhdVennDiagram} 
            alt="Defining ADHD - Venn diagram showing DSM-5 criteria with inattention and impulsivity/hyperactivity overlapping to create combined type"
            className="w-52 h-auto rounded-md border border-gray-300 float-right ml-6 mb-4"
          />
        ...
        <section id="causes" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <img 
            src={adhdCausesImage} 
            alt="ADHD origins - Brain illustration showing neural pathways and connections related to ADHD causes"
            className="w-48 h-auto rounded-md border border-gray-300 float-right ml-6 mb-4"
          />
        ...
        <section id="diagnosis" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <img 
            src={adhdDiagnosisImage} 
            alt="ADHD diagnosis - Flowchart showing the diagnostic process for ADHD"
            className="w-52 h-auto rounded-md border border-gray-300 float-right ml-6 mb-4"
          />
        ...
        <section id="support" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <img 
            src={adhdSupportImage} 
            alt="ADHD support - Visual representation of various support and management strategies for ADHD"
            className="w-52 h-auto rounded-md border border-gray-300 float-right ml-6 mb-4"
          />
        ...
        <section id="living" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <img 
            src={adhdLivingImage} 
            alt="Living positively with ADHD - Yellow flowers in cyan vase with 'Think Positive, Feel Positive, Live Positive' sign"
            className="w-52 h-auto rounded-md border border-gray-300 float-right ml-6 mb-4"
          />
