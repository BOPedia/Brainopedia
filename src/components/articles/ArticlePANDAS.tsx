    ...
    <article className="max-w-6xl">
      ...
      <div className="space-y-8 mt-20 clear-both">
        ...
        <section id="causes" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <p className="mb-4">PANDAS is caused by an autoimmune response to streptococcal infection.<sup<6/>sup> When the immune system fights a streptococcal infection (such as strep throat or scarlet fever), it produces antibodies to attack the bacteria.<sup>[17]</sup> In PANDAS, these antibodies mistakenly cross-react with and attack parts of the brain, particularly the basal ganglia—a brain region crucial for movement control, behavior regulation, and habit formation.<sup>[18]</sup></p>
