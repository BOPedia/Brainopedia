    ...
    <article className="max-w-6xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="mb-4">
            Self-care activities that involve intense sensory experiences can be modified:<sup>3</sup>
          </p>
          <ul className="list-disc ml-6 mb-4">
            ...
            that minimize sensory input<sup>3</sup></li>
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            <li className="mb-2">Create calm eating environments with minimal sensory distractions<sup>6</sup></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="mb-4">
            Educating others about SPD supports understanding and accommodation:<sup>1</sup>
          </p>
          <ul className="list-disc ml-6 mb-4">
        ...
        <div>
          ...
          <p className="mb-4">
            Formal accommodations through IEPs or 504 plans can include:<sup>3</sup>
          </p>
          <ul className="list-disc ml-6 mb-4">
        ...
        <div>
          ...
          <p className="mb-4">
            Self-advocacy—the ability to understand and communicate one's needs—is crucial for living well with SPD:<sup>1</sup>
          </p>
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            <li className="mb-2"><strong>Problem-solving:</strong> Identify potential solutions and negotiate accommodations<sup>1</sup></li>
        ...
        <div>
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            <li className="mb-2">Build your child's self-awareness and self-advocacy skills<sup>1</sup></li>
