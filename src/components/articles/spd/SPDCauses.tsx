      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="mb-4">
            ...
            structure, connectivity, and function related to sensory processing.<sup>13</sup>
          </p>
          <p className="mb-4">
        ...
        <div>
          ...
          <p className="mb-4">
            ...
            sensory information, and sensory cortices may process information differently in individuals with SPD.<sup>13</sup>
          </p>
          <p className="mb-4">
        ...
        <div>
          ...
          <p className="mb-4">
            ...
            a single causative gene.<sup>13</sup>
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mb-4">
            ...
            or nutritional deficiencies—might influence fetal brain development and subsequent sensory processing.<sup>13</sup> 
        ...
        <div>
          ...
          <p className="mb-4">
            The developing brain is shaped by sensory experiences, particularly during critical developmental periods.<sup>16</sup> 
            Ayres' theory emphasized the importance of sensory experiences for brain development.<sup>16</sup> Limited opportunities 
        ...
        <div>
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            genetic predisposition, neurological differences, and environmental factors rather than a single cause.<sup>13</sup></li>
