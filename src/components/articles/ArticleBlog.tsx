      ...
      <div className="mb-8">
        ...
        <div className="bg-gradient-to-r from-[#2abcd4]/10 to-[#ffd166]/20 border-l-4 border-[#2abcd4] p-4 sm:p-6 rounded-r-lg">
          ...
          <div className="flex flex-wrap gap-3">
            {/* Disabled visual placeholders instead of active links */}
            <div className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-md opacity-60 cursor-default text-sm">
