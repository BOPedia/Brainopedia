    ...
    <article className="max-w-6xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <ul className="list-disc ml-6 mb-4">
            <li className="mb-2"><strong>Making friends:</strong> Can be challenging due to language difficulties<sup>2</sup></li>
            <li className="mb-2"><strong>Maintaining friendships:</strong> Communication barriers affect relationships</li>
            <li className="mb-2"><strong>Social misunderstandings:</strong> Missing social cues<sup>3</sup></li>
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            <li className="mb-2">Structured activities with clear expectations<sup>4</sup></li>
          ...
          <ul className="list-disc ml-6 mb-4">
            <li className="mb-2">Communication central to relationships<sup>5</sup></li>
        ...
        <div>
          ...
          <ul className="list-disc ml-6 mb-4">
            <li className="mb-2"><strong>Language demands:</strong> Consider communication requirements of jobs<sup>6</sup></li>
