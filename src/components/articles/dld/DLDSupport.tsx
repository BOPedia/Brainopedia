      ...
      <div className="space-y-8">
        <div>
          <p className="mb-4">
            ...
            targeted intervention can significantly improve language outcomes.<sup>12</sup>
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc ml-6 mb-4">
            <li className="mb-2"><strong>Explicit teaching:</strong> Direct, systematic instruction of language skills<sup>13</sup></li>
            <li className="mb-2"><strong>Modeling:</strong> SLP models correct language forms repeatedly</li>
            <li className="mb-2"><strong>Recasting:</strong> Repeating child's utterance with corrections<sup>14</sup></li>
          ...
          <ul className="list-disc ml-6 mb-4">
            <li className="mb-2">Targeting specific grammatical morphemes (past tense, plurals)<sup>16</sup></li>
