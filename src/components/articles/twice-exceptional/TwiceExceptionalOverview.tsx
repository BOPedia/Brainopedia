    ...
    <article className="max-w-6xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="mb-4">
            The combination of giftedness and ADHD is increasingly recognized.<sup<2/>sup> These students 
            may demonstrate exceptional abilities in areas of interest while exhibiting inattention, 
            impulsivity, or hyperactivity that interferes with consistent performance.<sup<3/>sup> The 
            overlap in characteristics can complicate identification of both conditions.<sup<4/>sup>
          </p>
          ...
          <p className="mb-4">
            ...
            creative abilities with social-communication challenges and restricted interests.<sup<5/>sup> 
            Some demonstrate remarkable talents in specific domains while experiencing significant difficulty 
            with social interaction and adaptive functioning.<sup<6/>sup>
          </p>
