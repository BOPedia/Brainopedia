    ...
    <article className="max-w-6xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="mb-4">
            The hallmark inconsistency of 2e students complicates identification.<sup>2</sup> Performance 
            that varies dramatically across tasks, formats, or time periods may be misinterpreted as motivational 
            issues rather than recognized as a pattern indicating twice-exceptionality.<sup>3</sup>
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mb-4">
            Comprehensive IQ testing is essential for identifying twice-exceptionality.<sup>4</sup> The 
            Wechsler scales (WISC-V, WAIS-IV) provide detailed profiles across multiple domains including 
            Verbal Comprehension, Visual Spatial, Fluid Reasoning, Working Memory, and Processing Speed.<sup>5</sup> 
            The Stanford-Binet Fifth Edition offers higher ceilings appropriate for identifying profound 
            giftedness alongside disabilities.<sup>6</sup>
          </p>
      ...
      <section className="mt-12 pt-6 border-t-2 border-gray-300">
        ...
        <div className="text-sm space-y-2">
          ...
          <p>[31] Schultz, S. M. (2012). "Twice-exceptional students: Achieving brilliance despite learning challenges." <em>Communique</em>, 40(8), 19-21.</p>
          ...
          <p>[36] von Karolyi, C., Winner, E., Gray, W., & Sherman, G. F. (2003). "Dyslexia linked to talent: Global visual-spatial ability." <em>Brain and Language</em>, 85(3), 427-431.</p>
