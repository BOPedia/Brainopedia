      ...
      <div className="space-y-8">
        <div>
          <p className="mb-4">
            ...
            giftedness nor the disability should be neglected in favor of the other.<sup>12</sup>
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mb-4">
            A strength-based approach emphasizes developing talents while providing support for challenges.<sup>13</sup> 
            Focusing on what students can do rather than only on deficits builds confidence and motivation.<sup>14</sup> 
          ...
          <p className="mb-4">
            Effective programming provides both challenge for gifts and accommodations for disabilities.<sup>16</sup> 
