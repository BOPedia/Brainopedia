      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="space-y-6">
          <p>
            ...
            noises, can provoke intense feelings of anger, anxiety, disgust, or panic.<sup>12</sup>
          </p>
      ...
      <div className="space-y-8 mt-20 clear-both">
        <section id="overview" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <p className="mb-4">
            ...
            varying levels of severity.<sup>13</sup> It typically begins in late childhood or early adolescence, often 
            between ages 9-13, though it can develop at any age.<sup>14</sup> Unlike general noise sensitivity or hyperacusis 
          ...
          <p className="mb-4">
            ...
            context of the sound, particularly when produced by another person.<sup>16</sup> Common trigger sounds include eating 
