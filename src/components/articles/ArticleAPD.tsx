      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="space-y-6">
          <p>
            ...
            struggles to make sense of what the ears detect—creating a unique auditory neurotype.<sup>12</sup>
          </p>
      ...
      <div className="space-y-8 mt-20 clear-both">
        <section id="overview" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <p className="mb-4">
            ...
            sound.<sup>13</sup> The ears function normally, but the auditory pathways in the brain process sound 
            differently, making it challenging to distinguish between similar sounds, filter background 
            noise, remember auditory information, or quickly process verbal instructions.<sup>14</sup>
          </p>
          
          <p className="mb-4">
            Approximately 
            5% of school-aged children have APD, though it often goes undiagnosed.<sup>5</sup> The condition can occur 
            independently or alongside other neurodivergent conditions like ADHD, dyslexia, or autism.<sup>16</sup> APD 
