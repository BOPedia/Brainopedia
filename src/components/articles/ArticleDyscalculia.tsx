    ...
    <article className="max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="space-y-6">
          <p>
            ...
            calculations that are inconsistent with overall cognitive abilities.<sup>12</sup>
          </p>
      ...
      <div className="space-y-8 mt-20 clear-both">
        <section id="overview" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <p className="mb-4">
            Dyscalculia affects approximately 3-7% of the population and is thought to have a neurological basis.<sup>13</sup> 
            Like dyslexia, dyscalculia is not related to intelligence—individuals with dyscalculia can have average 
            or above-average intelligence and may excel in other academic areas such as reading, writing, or the arts.<sup>14</sup> 
        ...
        <section id="characteristics" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <p className="mb-4">
            ...
            facts, understanding mathematical concepts and operations, and estimating amounts or distances.<sup>16</sup> Beyond academic 
