      ...
      <div className="space-y-8">
        <div>
          <p className="mb-4">
            ...
            guides appropriate interventions and accommodations.<sup>12</sup>
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mb-4">
            ...
            eyesight.<sup>13</sup> They have additional training in visual perception, visual-motor integration, 
            and learning-related vision problems.<sup>14</sup> They can assess both eye function and visual 
          ...
          <p className="mb-4">
            ...
            functional skills.<sup>16</sup> They use standardized tests of visual processing and observe how 
