    ...
    <article className="max-w-6xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="mb-4">
            Tasks requiring discrimination between similar colors or shapes may be slower or more error-prone.<sup>1</sup> 
            Organizing items by visual characteristics is challenging.<sup>2</sup>
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mb-4">
            ...
            occurs.<sup>3</sup> The words on the page blend together, making it hard to focus on the 
            correct line.<sup>4</sup> Finger or bookmark tracking becomes necessary.<sup>5</sup>
          </p>
          ...
          <p className="mb-4">
            ...
            refrigerator, finding information on a busy worksheet) is extremely challenging.<sup>6</sup> 
