    ...
    <article className="max-w-6xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="mb-4">
            Vision refers to the eye's ability to see clearly—detecting light, color, and detail.<sup>13</sup> 
            Visual processing, in contrast, involves what the brain does with visual information after the eyes 
            send it to the brain.<sup>14</sup> It's entirely possible to have 20/20 vision but still struggle 
          ...
          <p className="mb-4">
            ...
            for interpretation, organization, and integration with other senses and cognitive functions.<sup>16</sup> 
