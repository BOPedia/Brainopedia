    ...
    <article className="max-w-6xl">
      ...
      <section className="mt-12 pt-6 border-t-2 border-gray-300">
        ...
        <div className="text-sm space-y-2">
          ...
          <p>[6] Hamstra-Bletz, L., & Blöte, A. W. (1993). "A longitudinal study on dysgraphic handwriting in primary school." <em>Journal of Learning Disabilities</em>, 26(10), 689-699.</p>
