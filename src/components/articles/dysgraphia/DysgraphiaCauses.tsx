    ...
    <article className="max-w-6xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <ul className="list-disc ml-6 mb-4">
            <li className="mb-2">Difficulty with motor planning and sequencing<sup<2/>sup></li>
            <li className="mb-2">Challenges integrating visual and motor information</li>
            <li className="mb-2">Problems with working memory during writing<sup<3/>sup></li>
            <li className="mb-2">Slower neural processing speed for orthographic coding<sup<4/>sup></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="mb-4">
            Research indicates dysgraphia has a genetic component:<sup<5/>sup>
          </p>
          <ul className="list-disc ml-6 mb-4">
            <li className="mb-2"><strong>Family clustering:</strong> Dysgraphia tends to run in families<sup<6/>sup></li>
