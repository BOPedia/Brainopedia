...
export function ArticleSchizophrenia({ setCurrentArticle }: ArticleSchizophreniaProps) {
  const sections = [
    ...
    { id: 'living', title: 'Living with Schizophrenia' },
  ];

  return (
    <article className="max-w-6xl">
      <style>{`sup { color: #10b981; }`}</style>
      <h1 className="pb-2 border-b-2 border-[#0c264d] mb-6 text-3xl">Schizophrenia</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div className="space-y-6">
          <p>
            ...
            processing information and experiencing consciousness, rather than simply a "broken brain."<sup>12</sup>
          </p>
      ...
      <div className="space-y-8 mt-20 clear-both">
        <section id="overview" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <img src="https://images.unsplash.com/photo-1687367168095-844e7908b0f2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwZXJjZXB0aW9uJTIwcmVhbGl0eSUyMGNvbnNjaW91c25lc3MlMjBtZW50YWx8ZW58MXx8fHwxNzY3NDA4MjgxfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" alt="Perception and reality - understanding schizophrenia" className="w-64 h-auto rounded-md border border-gray-300 float-right ml-6 mb-4" />
          <p className="mb-4">Schizophrenia affects approximately 1% of the global population and involves differences in brain structure, neurotransmitter function (particularly dopamine and glutamate), and neural connectivity.<sup>13</sup> Research shows variations in brain regions responsible for perception, thought organization, and reality testing.<sup>14</sup> The neurodivergent perspective acknowledges that individuals with schizophrenia experience reality through a different perceptual lens.<sup>5</sup></p>
          <p className="mb-4">While this can create significant challenges, it also represents a unique form of consciousness and human experience that deserves understanding and respect.<sup>16</sup> Related conditions include schizoaffective disorder (symptoms of both schizophrenia and a mood disorder), schizophreniform disorder (similar to schizophrenia but shorter duration), and brief psychotic disorder (sudden onset of psychotic symptoms lasting less than one month).<sup>7</sup> Understanding schizophrenia as a neurotype emphasizes the neurological basis and the importance of both support and dignity.<sup>8</sup></p>
        </section>

        <section id="characteristics" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          <h2 className="text-[#0c264d] font-bold mb-4 text-2xl">Symptoms & Characteristics</h2>
          <img src="https://images.unsplash.com/photo-1723283207299-aa59d7b17275?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhYnN0cmFjdCUyMHRob3VnaHQlMjBkaXNvcmdhbml6ZWQlMjBwYXR0ZXJuc3xlbnwxfHx8fDE3Njc0MDgyODF8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" alt="Abstract thought patterns - characteristics of schizophrenia" className="w-80 h-auto rounded-md border border-gray-300 float-right ml-6 mb-4" />
          <p className="mb-4">Schizophrenia involves a range of experiences traditionally categorized into positive, negative, and cognitive symptoms.<sup>9</sup> Positive symptoms (additions to experience) include hallucinations (perceiving things others don't, most commonly auditory but can be visual, tactile, or olfactory), delusions (strongly held beliefs that differ from shared reality), disorganized thinking (difficulty organizing thoughts in conventional patterns), and unusual movements or catatonia.<sup>[10][11]</sup></p>
          <p className="mb-4">Negative symptoms (reductions in experience) include reduced emotional expression, decreased motivation (avolition), social withdrawal, reduced speech (alogia), and difficulty experiencing pleasure (anhedonia).<sup>12</sup> Cognitive symptoms include difficulties with working memory, challenges with executive function, attention difficulties, and processing speed variations.<sup>13</sup> Viewing schizophrenia through a neurodivergent lens acknowledges that experiences like hallucinations represent real neurological phenomena and genuine perceptions even if not shared by others, recognizes exceptional creativity, unique perspectives, and profound philosophical insights many individuals demonstrate, honors that experiences can hold personal meaning and significance, emphasizes the whole person rather than reducing them to a diagnosis, and recognizes the abilities, resilience, and courage required to navigate a world designed for neurotypical perception.<sup>[14][15]</sup></p>
        </section>

        <section id="causes" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          <h2 className="text-[#0c264d] font-bold mb-4 text-2xl">Causes & Origins</h2>
          <img src="https://images.unsplash.com/photo-1709651669999-57741c9bf085?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxicmFpbiUyMGRvcGFtaW5lJTIwbmV1cm90cmFuc21pdHRlcnMlMjBuZXVyYWx8ZW58MXx8fHwxNzY3NDA4MjgyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" alt="Brain neurotransmitters - neurological basis of schizophrenia" className="w-64 h-auto rounded-md border border-gray-300 float-right ml-6 mb-4" />
          <p className="mb-4">Schizophrenia involves differences in brain structure, neurotransmitter function (particularly dopamine and glutamate), and neural connectivity.<sup>16</sup> Research shows variations in brain regions responsible for perception, thought organization, and reality testing including the prefrontal cortex, hippocampus, and thalamus.<sup>[17][18]</sup> Brain imaging reveals structural and functional differences in neural circuits that process perception, organize thoughts, and distinguish internal from external stimuli.<sup>[19]</sup></p>
          <p className="mb-4">Schizophrenia has a strong genetic component with studies showing increased risk in family members, though the genetics are complex involving multiple genes and their interactions.<sup>[20][21]</sup> Environmental factors including prenatal factors (maternal infection, malnutrition), birth complications, childhood trauma, and substance use can contribute to development or exacerbation in those with genetic vulnerability.<sup>[22][23]</sup> The condition represents a fundamental difference in how the brain processes perception, organizes thoughts, and experiences reality, creating a distinct form of consciousness and perceptual experience.<sup>[24]</sup></p>
        </section>

        <section id="diagnosis" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          <h2 className="text-[#0c264d] font-bold mb-4 text-2xl">Testing & Diagnosing</h2>
          <img src="https://images.unsplash.com/photo-1653130892581-7c0ae1f4e8e0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwc3ljaGlhdHJpYyUyMGV2YWx1YXRpb24lMjBtZW50YWwlMjBoZWFsdGh8ZW58MXx8fHwxNzY3NDA4MjgyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" alt="Psychiatric evaluation - diagnosing schizophrenia" className="w-80 h-auto rounded-md border border-gray-300 float-right ml-6 mb-4" />
          <p className="mb-4">Schizophrenia is diagnosed clinically by mental health professionals including psychiatrists or psychologists.<sup>[25]</sup> The diagnostic criteria include two or more of the following symptoms present for a significant portion of time during a one-month period: delusions, hallucinations, disorganized speech, grossly disorganized or catatonic behavior, or negative symptoms.<sup>[26]</sup> Additionally, functioning in major areas (work, relationships, self-care) is significantly below pre-onset levels, continuous signs persist for at least six months, other conditions are ruled out (mood disorders, substance use, medical conditions), and if autism or communication disorder is present, prominent delusions or hallucinations must also be present.<sup>[27]</sup></p>
          <p className="mb-4">The evaluation includes detailed clinical interview and psychiatric history, assessment of symptoms and their duration, medical evaluation to rule out other causes, screening for substance use, neuropsychological testing when appropriate, and gathering information from family or others when possible.<sup>[28][29]</sup> Onset is typically in late teens to early 30s, with men often experiencing onset earlier than women.<sup>[30]</sup> Early intervention and coordinated specialty care programs have shown improved outcomes.<sup>[31]</sup></p>
        </section>

        <section id="support" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          <h2 className="text-[#0c264d] font-bold mb-4 text-2xl">Support & Management</h2>
          <img src="https://images.unsplash.com/photo-1763310225009-50214e3c99d9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0aGVyYXB5JTIwc3VwcG9ydCUyMHJlY292ZXJ5JTIwd2VsbG5lc3N8ZW58MXx8fHwxNzY3NDA4MjgzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" alt="Therapy and recovery support - managing schizophrenia" className="w-80 h-auto rounded-md border border-gray-300 float-right ml-6 mb-4" />
          <p className="mb-4">A neurodivergent-affirming approach emphasizes collaboration, choice, and quality of life.<sup>[32]</sup> Medication including antipsychotic medications can help manage symptoms by affecting dopamine and other neurotransmitter systems, with finding the right medication and dosage being highly individual and a collaborative decision.<sup>[33][34]</sup> Therapy and counseling including Cognitive Behavioral Therapy (CBT), family therapy, and peer support can help develop coping strategies and improve quality of life, with emphasis on understanding rather than simply eliminating experiences.<sup>[35]</sup></p>
          <p className="mb-4">Supported employment and education programs provide accommodations and support for work and educational goals, recognizing abilities and potential.<sup>[36]</sup> Peer support and community including connection with others who share similar experiences provides validation, practical strategies, and reduces isolation, with organizations like the Hearing Voices Network offering alternatives to purely medical models.<sup>[37][38]</sup> Trauma-informed care recognizes that many individuals have experienced trauma which may be connected to their perceptual experiences, with addressing trauma being an important part of healing and wellbeing.<sup>[39]</sup> Additional support includes case management and coordinated care, housing support, social skills training, and crisis planning.<sup>[40]</sup></p>
        </section>
        ...
        <section id="living" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <img src="https://images.unsplash.com/photo-1687367168095-844e7908b0f2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwZXJjZXB0aW9uJTIwcmVhbGl0eSUyMGNvbnNjaW91c25lc3MlMjBtZW50YWx8ZW58MXx8fHwxNzY3NDA4MjgxfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" alt="Living with schizophrenia - navigating unique experiences" className="w-80 h-auto rounded-md border border-gray-300 float-right ml-6 mb-4" />
          <p className="mb-4">Individuals with schizophrenia lead meaningful and fulfilling lives across all areas of society.<sup>[41]</sup> Schizophrenia is a lifelong neurotype that individuals learn to navigate and manage throughout their lives.<sup>[42]</sup> Living with schizophrenia involves understanding and working with one's unique perceptual experiences, accessing appropriate support, and building a meaningful life.<sup>[43]</sup> With appropriate treatment, peer support, accommodations, and self-understanding, people with schizophrenia thrive in education, careers, relationships, and creative pursuits.<sup>[44]</sup></p>
          <p className="mb-4">Living well with schizophrenia involves understanding one's specific experiences and patterns, accessing appropriate medication and therapeutic support, building peer connections and community, developing strategies for managing challenging experiences, accessing accommodations in education and employment, and recognizing both the challenges and unique perspectives of the neurotype.<sup>[45]</sup> Topics related to living with schizophrenia include navigating different perceptual experiences, leveraging creativity and unique insights, building meaningful relationships, managing stigma and misconceptions, accessing appropriate support and accommodations, connecting with peer support and advocacy movements, understanding that perceptual differences are real neurological phenomena not personal failings, and developing resilience, self-advocacy skills, and self-understanding through the experience.<sup>[46]</sup></p>
        </section>
      </div>
