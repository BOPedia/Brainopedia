    ...
    <article className="max-w-6xl">
      ...
      <div className="space-y-8 mt-20 clear-both">
        ...
        <section id="characteristics" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <p className="mb-4">TBI can affect any aspect of cognition depending on injury location and severity.<sup>1</sup> Attention and concentration difficulties include difficulty sustaining focus, being easily distracted, trouble dividing attention between multiple tasks, and mental fatigue with reduced stamina.<sup>1</sup> Memory challenges include short-term memory difficulties, challenges forming new memories, difficulty retrieving memories from before injury, forgetting conversations or appointments, and problems with prospective memory.<sup>2</sup></p>
