...
export function ArticleTBI({ setCurrentArticle }: ArticleTBIProps) {
  const sections = [
    ...
    { id: 'living', title: 'Living with TBI' },
  ];
    ...
    <article className="max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div className="space-y-6">
          <p>
            ...
            processing, and behavior.<sup>10</sup> When these changes persist beyond initial recovery, TBI becomes a 
      ...
      <div className="space-y-8 mt-20 clear-both">
        <section id="overview" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <p className="mb-4">Importantly, a TBI doesn't erase who someone was—it creates a new neurological reality.<sup>8</sup> Understanding TBI as acquired neurodivergence validates this experience and emphasizes the need for ongoing support and accommodation.<sup>9</sup></p>
        </section>

        <section id="characteristics" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          <h2 className="text-[#0c264d] font-bold mb-4 text-2xl">Symptoms & Characteristics</h2>
          <img src="https://images.unsplash.com/photo-1740908900846-271f4f021b6a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb2duaXRpdmUlMjBtZW1vcnklMjBjb25mdXNpb24lMjBtZW50YWwlMjBoZWFsdGh8ZW58MXx8fHwxNzY3NDEwMzM4fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" alt="Cognitive and memory challenges following TBI" className="w-80 h-auto rounded-md border border-gray-300 float-right ml-6 mb-4" />
          <p className="mb-4">TBI can affect any aspect of cognition depending on injury location and severity.<sup>10</sup> Attention and concentration difficulties include difficulty sustaining focus, being easily distracted, trouble dividing attention between multiple tasks, and mental fatigue with reduced stamina.<sup<1/>sup> Memory challenges include short-term memory difficulties, challenges forming new memories, difficulty retrieving memories from before injury, forgetting conversations or appointments, and problems with prospective memory.<sup<2/>sup></p>
          <p className="mb-4">Executive functioning difficulties include planning and organization challenges, difficulty with multi-step tasks, impaired problem-solving and reasoning, reduced cognitive flexibility, poor impulse control and judgment, and difficulty initiating tasks.<sup<3/>sup> Processing speed changes include slowed information processing, needing more time to understand or respond, delayed reaction times, and fatigue from mental effort.<sup<4/>sup></p>
          <p className="mb-4">Communication and language challenges include word-finding difficulties, trouble organizing thoughts into speech, challenges with social communication, and difficulty understanding complex or abstract language.<sup<5/>sup> Sensory processing changes include sensitivity to light, sound or touch, difficulty filtering sensory information, visual processing changes, vestibular dysfunction, and changes to taste or smell.<sup<6/>sup></p>
        ...
        <section id="causes" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <img src="https://images.unsplash.com/photo-1758404958502-44f156617bae?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhY2NpZGVudCUyMGVtZXJnZW5jeSUyMGluanVyeSUyMHRyYXVtYXxlbnwxfHx8fDE3Njc0MTAzMzh8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" alt="Emergency trauma - causes of traumatic brain injury" className="w-64 h-auto rounded-md border border-gray-300 float-right ml-6 mb-4" />
        ...
        <section id="diagnosis" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <img src="https://images.unsplash.com/photo-1549925245-f20a1bac6454?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxicmFpbiUyMHNjYW4lMjBDVCUyME1SSSUyMG5ldXJvaW1hZ2luZ3xlbnwxfHx8fDE3Njc0MTAzMzl8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" alt="Brain imaging and neurological testing for TBI diagnosis" className="w-80 h-auto rounded-md border border-gray-300 float-right ml-6 mb-4" />
        ...
        <section id="support" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <img src="https://images.unsplash.com/photo-1764314138160-5f04f4a50dae?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZWhhYmlsaXRhdGlvbiUyMHRoZXJhcHklMjByZWNvdmVyeSUyMHN1cHBvcnR8ZW58MXx8fHwxNzY3NDEwMzM5fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" alt="Rehabilitation and therapeutic support for TBI recovery" className="w-80 h-auto rounded-md border border-gray-300 float-right ml-6 mb-4" />
        ...
        <section id="living" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <img src="https://images.unsplash.com/photo-1695370993551-8ac683cd6134?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhZGFwdGF0aW9uJTIwcmVzaWxpZW5jZSUyMGxpZmUlMjBxdWFsaXR5JTIwd2VsbG5lc3N8ZW58MXx8fHwxNzY3NDEwMzM5fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" alt="Adaptation and quality of life after TBI" className="w-80 h-auto rounded-md border border-gray-300 float-right ml-6 mb-4" />
