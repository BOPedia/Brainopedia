    ...
    <article className="max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div className="space-y-6">
          <p>
            ...
            experiences the world.<sup>12</sup>
          </p>
      ...
      <div className="space-y-8 mt-20 clear-both">
        <section id="overview" className="bg-white border-2 border-[#2abcd4] rounded-lg p-6 shadow-sm">
          ...
          <p className="mb-4">Approximately 2.8 million TBIs occur annually in the United States alone, with an estimated 5.3 million Americans currently living with TBI-related disabilities.<sup>13</sup> TBI can result from falls, motor vehicle accidents, sports injuries, assaults, blast injuries, or any event causing the brain to move rapidly inside the skull or be penetrated by an object.<sup>14</sup></p>
          <p className="mb-4">The effects of TBI are highly variable, depending on which areas of the brain are damaged, the severity of injury, and individual factors.<sup>5</sup> Some individuals make significant recovery, while others experience permanent changes requiring lifelong accommodation.<sup>16</sup> TBI is often called an "invisible disability" because cognitive and emotional changes may not be outwardly apparent, leading to misunderstanding and lack of support.<sup>7</sup></p>
