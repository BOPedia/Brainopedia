...
export const learningDifferencesRoutes: RouteMap = {
  ...
  // Future Dyslexia Tabs (Uncomment as you build them!)
  ...
  'dyscalculia-support': lazy(() => import('../dyscalculia/DyscalculiaSupport').then(m => ({ default: m.DyscalculiaSupport }))), // This one is live!
  
  // Future Dyscalculia Tabs
